...
def xla_call_module(args, version, module, Sout, Tout, dim_args_spec=[], platforms=[], function_list=[], has_token_input_output=False, name=None):
  ...
  if tld.is_eager:
    ...
    try:
      _result = _dispatcher_for_xla_call_module(
          ...
          function_list, has_token_input_output, name,), None)
      if _result is not NotImplemented:
        return _result
      return xla_call_module_eager_fallback(
          ...
          has_token_input_output=has_token_input_output, name=name, ctx=_ctx)
    except _core._SymbolicException:
      pass  # Add nodes to the TensorFlow graph.
    except (TypeError, ValueError):
      _result = _dispatch.dispatch(
  ...
  if _execute.must_record_gradient():
    _attrs = ("version", _op._get_attr_int("version"), "module",
              ...
              _op._get_attr_bool("has_token_input_output"))
    _inputs_flat = _op.inputs
    _execute.record_gradient(
...
def xla_call_module_eager_fallback(args, version, module, Sout, Tout, dim_args_spec, platforms, function_list, has_token_input_output, name, ctx):
  version = _execute.make_int(version, "version")
  module = _execute.make_str(module, "module")
  if not isinstance(Sout, (list, tuple)):
    raise TypeError(
