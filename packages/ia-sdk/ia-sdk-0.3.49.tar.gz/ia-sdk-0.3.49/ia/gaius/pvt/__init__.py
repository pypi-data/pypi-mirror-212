...
def get_emotives_polarity_metrics(emotives_set, this_test_log, overall=False):
    ...
    template_dict = {'predictions': [],
                     'actuals': [],
                     'overall': {'metrics': {'true_positive': 0.0,
                                 'false_positive': 0.0,
                                             'true_negative': 0.0,
                                             'false_negative': 0.0,
                     ...
                     'positive': {'metrics': {'true_positive': 0.0,
                                              'false_positive': 0.0,
                                              'true_negative': 0.0,
                                              'false_negative': 0.0,
                                              'unknown_percentage': 0.0,
                     ...
                     'negative': {'metrics': {'true_positive': 0.0,
                                              'false_positive': 0.0,
                                              'true_negative': 0.0,
                                              'false_negative': 0.0,
                                              'unknown_percentage': 0.0,
            ...
            for node, info in v.items():
                for emotive, emotive_data in info.items():
                    if emotive in emo_res2[node]:
                        emo_res2[node][emotive][metric_type]['metrics'][k] = deepcopy(
                            emotive_data)

    for node, results in emo_res2.items():
        for emotive, metrics in results.items():
            for emo_type in ['positive', 'negative', 'overall']:
                metrics[emo_type]['metrics']['training_counter'] = raw_test_results['training_counter'][emotive][emo_type]
                metrics[emo_type]['metrics']['testing_counter'] = raw_test_results['testing_counter'][emotive][emo_type]
                metrics[emo_type]['metrics']['counter'] = raw_test_results['counter'][emotive][emo_type]
