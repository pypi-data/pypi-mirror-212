...
def exchange_data_itm(str_received, portname = 'COM5', boud = 19200):
    global str_change
    global strout
    global ia
    ba2=bytearray(2)
    ...
    nummc1=str_change.find('mc1') # 
    nummc2=str_change.find('mc2')
    ...
    numRref3=str_change.find('Rref3')
    ...
    numhk1=str_change.find('hk1') # компенсатор\канал
    ...
    numvalch5=str_change.find('valch5')
    ...
    if str_change[0]=='R':  #read data
        if nummc1>-1:
            inbuff=ReadTwoBytesMBus(portname,boud,0x4d,0x100,1)
            if inbuff:
                par=inbuff[1]&0x0f
        ...
        if nummc2>-1:
            inbuff=ReadTwoBytesMBus(portname,boud,0x4d,0x101,1)
            if inbuff:
                par=inbuff[1]&0x0f
        ...
        if nummc3>-1:
            inbuff=ReadTwoBytesMBus(portname,boud,0x4d,0x102,1)
            if inbuff:
                par=inbuff[1]&0x0f
        ...
        if nummc4>-1:
            inbuff=ReadTwoBytesMBus(portname,boud,0x4d,0x103,1)
            if inbuff:
                par=inbuff[1]&0x0f
        ...
        if nummc5>-1:
            inbuff==ReadTwoBytesMBus(portname,boud,0x4d,0x104,1)
            if inbuff:
                par=inbuff[1]&0x0f
        ...
        if nummc6>-1:
            inbuff==ReadTwoBytesMBus(portname,boud,0x4d,0x105,1)
            if inbuff:
                par=inbuff[1]&0x0f
        ...
        if nummc7>-1:
            inbuff==ReadTwoBytesMBus(portname,boud,0x4d,0x106,1)
            if inbuff:
                par=inbuff[1]&0x0f
        ...
        if nummc8>-1:
            inbuff==ReadTwoBytesMBus(portname,boud,0x4d,0x107,1)
            if inbuff:
                par=inbuff[1]&0x0f
        ...
        if numsen1>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x108,1)
            if inbuff:
                sen=inbuff[0]
                sen1=sen[0]
        ...
        if numsen2>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x109,1)
            if inbuff:
                sen=inbuff[0]
                sen2=sen[0]
        ...
        if numsen3>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x10a,1)
            if inbuff:
                sen=inbuff[0]
                sen3=sen[0]
        ...
        if numsen4>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x10b,1)
            if inbuff:
                sen=inbuff[0]
                sen4=sen[0]
        ...
        if numsen5>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x10c,1)
            if inbuff:
                sen=inbuff[0]
                sen5=sen[0]
        ...
        if numsen6>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x10d,1)
            if inbuff:
                sen=inbuff[0]
                sen6=sen[0]
        ...
        if numsen7>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x10e,1)
            if inbuff:
                sen=inbuff[0]
                sen7=sen[0]
        ...
        if numsen8>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x10f,1)
            if inbuff:
                sen=inbuff[0]
                sen8=sen[0]
        ...
        if numhk1>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x45,1)
            if inbuff:
                hk=inbuff[0]
                hk1=hk[0]
                if hk1==0: parhk='ON'
        ...
        if numhk2>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x46,1)
            if inbuff:
                hk=inbuff[0] 
                hk2=hk[0]
                if hk2==0: parhk='ON'
        ...
        if numhk3>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x47,1)
            if inbuff:
                hk=inbuff[0]   
                hk3=hk[0]
                if hk3==0: parhk='ON'
        ...
        if numhk4>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x48,1)
            if inbuff:
                hk=inbuff[0]   
                hk4=hk[0]
                if hk4==0: parhk='ON'
        ...
        if numhk5>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x49,1)
            if inbuff:
                hk=inbuff[0]   
                hk5=hk[0]
                if hk5==0: parhk='ON'
        ...
        if numhk6>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x4a,1)
            if inbuff:
                hk=inbuff[0]   
                hk6=hk[0]
                if hk6==0: parhk='ON'
        ...
        if numhk7>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x4b,1)
            if inbuff:
                hk=inbuff[0]   
                hk7=hk[0]
                if hk7==0: parhk='ON'
        ...
        if numhk8>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x4c,1)
            if inbuff:
                hk=inbuff[0]   
                hk8=hk[0]
                if hk8==0: parhk='ON'
        ...
        if numvalch1>-1:
            inbuff=ReadIntMBus(portname,boud,0x4d,0x0208,1)
            if inbuff:
        ...
        if numvalch2>-1:
            inbuff=ReadIntMBus(portname,boud,0x4d,0x0209,1)
            if inbuff:
        ...
        if numvalch3>-1:
            inbuff=ReadIntMBus(portname,boud,0x4d,0x020a,1)
            if inbuff:
        ...
        if numvalch4>-1:
            inbuff=ReadIntMBus(portname,boud,0x4d,0x020b,1)
            if inbuff:
        ...
        if numvalch5>-1:
            inbuff=ReadIntMBus(portname,boud,0x4d,0x020c,1)
            if inbuff:
        ...
        if numvalch6>-1:
            inbuff=ReadIntMBus(portname,boud,0x4d,0x020d,1)
            if inbuff:
        ...
        if numvalch7>-1:
            inbuff=ReadIntMBus(portname,boud,0x4d,0x020e,1)
            if inbuff:
        ...
        if numvalch8>-1:
            inbuff=ReadIntMBus(portname,boud,0x4d,0x020f,1)
            if inbuff:
        ...
        if numvalrefu>-1:
            inbuff=ReadFloatMBus(portname,boud,0x4d,0x44,1)
            if inbuff:
        ...
        if numRr1>-1:
            inbuff=ReadFloatMBus(portname,boud,0x4d,0x40,1)
            if inbuff:
                floatRr1=inbuff[0]    
        ...
        if numsen1>-1:
            ...
            if isinstance(senval,str):
                ...
                ia[0]=senval
                if WriteUint16_tMBus(portname,boud,0x4d,0x108,1,ia):
                    strout+=',sen1-OK'
                else:
                    strout+=',sen1-Err'
        ...
        if numsen2>-1:
            ...
            if isinstance(senval,str):
                ...
                ia[0]=senval
                if WriteUint16_tMBus(portname,boud,0x4d,0x109,1,ia):
                    strout+=',sen2-OK'
                else:
                    strout+=',sen2-Err'
        ...
        if numsen3>-1:
            ...
            if isinstance(senval,str):
                ...
                ia[0]=senval
                if WriteUint16_tMBus(portname,boud,0x4d,0x10a,1,ia):
                    strout+=',sen3-OK'
                else:
                    strout+=',sen3-Err'
        ...
        if numsen4>-1:
            ...
            if isinstance(senval,str):
                ...
                ia[0]=senval
                if WriteUint16_tMBus(portname,boud,0x4d,0x10b,1,ia):
                    strout+=',sen4-OK'
                else:
                    strout+=',sen4-Err'
        ...
        if numsen5>-1:
            ...
            if isinstance(senval,str):
                ...
                ia[0]=senval
                if WriteUint16_tMBus(portname,boud,0x4d,0x10c,1,ia):
                    strout+=',sen5-OK'
                else:
                    strout+=',sen5-Err'
        ...
        if numsen6>-1:
            ...
            if isinstance(senval,str):
                ...
                ia[0]=senval
                if WriteUint16_tMBus(portname,boud,0x4d,0x10d,1,ia):
                    strout+=',sen6-OK'
                else:
                    strout+=',sen6-Err'
        ...
        if numsen7>-1:
            ...
            if isinstance(senval,str):
                ...
                ia[0]=senval
                if WriteUint16_tMBus(portname,boud,0x4d,0x10e,1,ia):
                    strout+=',sen7-OK'
                else:
                    strout+=',sen7-Err'
        ...
        if numsen8>-1:
            ...
            if isinstance(senval,str):
                ...
                ia[0]=senval
                if WriteUint16_tMBus(portname,boud,0x4d,0x10f,1,ia):
                    strout+=',sen8-OK'
                else:
                    strout+=',sen8-Err'
        ...
        if numRref1>-1:
            ...
            if parRref=='errval':
                ...
                if inbuff:
                    ...
                    if WriteTwoBytesMBus(portname,boud,0x4d,0X100,1,inbuff):
                        strout+=',Rref1-OK'
                    else:
                        strout+=',Rref1-Err'
        if numRref2>-1:
            ...
            if parRref=='errval':
                ...
                if inbuff:
                    inbuff[0]&=0x0f
                    inbuff[0]|=Rrefrstrpar(parval)
                    if WriteTwoBytesMBus(portname,boud,0x4d,0X101,1,inbuff):
                        strout+=',Rref2-OK'
                    else:
                        strout+=',Rref2-Err'
        if numRref3>-1:
            ...
            if parRref=='errval':
                ...
                if inbuff:
                    inbuff[0]&=0x0f
                    inbuff[0]|=Rrefrstrpar(parval)
                    if WriteTwoBytesMBus(portname,boud,0x4d,0X102,1,inbuff):
                        strout+=',Rref3-OK'
                    else:
                        strout+=',Rref3-Err'
        if numRref4>-1:
            ...
            if parRref=='errval':
                ...
                if inbuff:
                    inbuff[0]&=0x0f
                    inbuff[0]|=Rrefrstrpar(parval)
                    if WriteTwoBytesMBus(portname,boud,0x4d,0X103,1,inbuff):
                        strout+=',Rref4-OK'
                    else:
                        strout+=',Rref4-Err'
        if numRref5>-1:
            ...
            if parRref=='errval':
                ...
                if inbuff:
                    inbuff[0]&=0x0f
                    inbuff[0]|=Rrefrstrpar(parval)
                    if WriteTwoBytesMBus(portname,boud,0x4d,0X104,1,inbuff):
                        strout+=',Rref5-OK'
                    else:
                        strout+=',Rref5-Err'
        if numRref6>-1:
            ...
            if parRref=='errval':
                ...
                if inbuff:
                    inbuff[0]&=0x0f
                    inbuff[0]|=Rrefrstrpar(parval)
                    if WriteTwoBytesMBus(portname,boud,0x4d,0X105,1,inbuff):
                        strout+=',Rref6-OK'
                    else:
                        strout+=',Rref6-Err'
        if numRref7>-1:
            ...
            if parRref=='errval':
                ...
                if inbuff:
                    inbuff[0]&=0x0f
                    inbuff[0]|=Rrefrstrpar(parval)
                    if WriteTwoBytesMBus(portname,boud,0x4d,0X106,1,inbuff):
                        strout+=',Rref7-OK'
                    else:
                        strout+=',Rref7-Err'
        if numRref8>-1:
            ...
            if parRref=='errval':
                ...
                if inbuff:
                    inbuff[0]&=0x0f
                    inbuff[0]|=Rrefrstrpar(parval)
                    if WriteTwoBytesMBus(portname,boud,0x4d,0X107,1,inbuff):
                        strout+=',Rref8-OK'
                    else:
                        strout+=',Rref8-Err' 
              
        if nummc1>-1:
            parval=str_par_ToUint16_t(str_change,'mc1')
        ...
        if nummc2>-1:
            parval=str_par_ToUint16_t(str_change,'mc2')
            parmc= meascurrentstrpar (parval)
            if parmc=='errval':
                strout+=',mc2-errval'
            else:
                ...
                if inbuff:
                    ...
                    if WriteTwoBytesMBus(portname,boud,0x4d,0X101,1,inbuff):
                        ...
                        strout+=',mc2-Err'
        if nummc3>-1:
            parval=str_par_ToUint16_t(str_change,'mc3')
            parmc= meascurrentstrpar (parval)
            if parmc=='errval':
                strout+=',mc3-errval'
            else: 
        ...
        if numhk1>-1:
            ...
            if parval=='ON':
                ba2[0]=0
                ba2[1]=0
                if WriteTwoBytesMBus(portname,boud,0x4d,0X45,1,ba2):
                    strout+=',hk1-OK'
                else: strout+=',hk1-Err'
            elif parval=='OFF':
                ba2[0]=0xff
        ...
        if numhk2>-1:
            ...
            if parval=='ON':
                ba2[0]=0
                ba2[1]=0
                if WriteTwoBytesMBus(portname,boud,0x4d,0X46,1,ba2):
                    strout+=',hk2-OK'
                else: strout+=',hk2-Err'
            elif parval=='OFF':
                ba2[0]=0xff
        ...
        if numhk3>-1:
            ...
            if parval=='ON':
                ba2[0]=0
                ba2[1]=0
                if WriteTwoBytesMBus(portname,boud,0x4d,0X47,1,ba2):
                    strout+=',hk3-OK'
                else: strout+=',hk3-Err'
            elif parval=='OFF':
                ba2[0]=0xff
        ...
        if numhk4>-1:
            ...
            if parval=='ON':
                ba2[0]=0
                ba2[1]=0
                if WriteTwoBytesMBus(portname,boud,0x4d,0X48,1,ba2):
                    strout+=',hk4-OK'
                else: strout+=',hk4-Err'
            elif parval=='OFF':
                ba2[0]=0xff
        ...
        if numhk5>-1:
            ...
            if parval=='ON':
                ba2[0]=0
                ba2[1]=0
                if WriteTwoBytesMBus(portname,boud,0x4d,0X49,1,ba2):
                    strout+=',hk5-OK'
                else: strout+=',hk5-Err'
            elif parval=='OFF':
                ba2[0]=0xff
        ...
        if numhk6>-1:
            ...
            if parval=='ON':
                ba2[0]=0
                ba2[1]=0
                if WriteTwoBytesMBus(portname,boud,0x4d,0X4a,1,ba2):
                    strout+=',hk6-OK'
                else: strout+=',hk6-Err'
            elif parval=='OFF':
                ba2[0]=0xff
        ...
        if numhk7>-1:
            ...
            if parval=='ON':
                ba2[0]=0
                ba2[1]=0
                if WriteTwoBytesMBus(portname,boud,0x4d,0X4b,1,ba2):
                    strout+=',hk7-OK'
                else: strout+=',hk1-Err'
            elif parval=='OFF':
                ba2[0]=0xff
        ...
        if numhk8>-1:
            ...
            if parval=='ON':
                ba2[0]=0
                ba2[1]=0
                if WriteTwoBytesMBus(portname,boud,0x4d,0X4c,1,ba2):
                    strout+=',hk8-OK'
                else: strout+=',hk8-Err'
            elif parval=='OFF':
                ba2[0]=0xff
        ...
        if numRr1>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                print('fa[0]=parval',fa[0])
                wrf=WriteFloatMBus(portname,boud,0x4d,0x40,1,fa)
                if wrf:
                    strout+=',Rr1-OK'
                else:
                    strout+=',Rr1-Err'
        ...
        if numRr2>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                wrf=WriteFloatMBus(portname,boud,0x4d,0x41,1,fa)
                if wrf:  
                    strout+=',Rr2-OK'
                else:
                    strout+=',Rr2-Err'
        ...
        if numRr3>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                wrf=WriteFloatMBus(portname,boud,0x4d,0x42,1,fa)
                if wrf:
                    strout+=',Rr3-OK'
                else:
                    strout+=',Rr3-Err'
        ...
        if numish1A>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x4e,1,fa):
                    strout+=',ish1A-OK'
                else:
                    strout+=',ish1A-Err'
        if numish1B>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x4f,1,fa):
                    strout+=',ish1B-OK'
                else:
                    strout+=',ish1B-Err'
        if numish1C>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x50,1,fa):
                    strout+=',ish1C-OK'
                else:
                    strout+=',ish1C-Err'
        if numish1D>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x51,1,fa):
                    strout+=',ish1D-OK'
                else:
                    strout+=',ish1D-Err'
        if numish1Wal>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x52,1,fa):
                    strout+=',ish1Wal-OK'
                else:
                    strout+=',ish1Wal-Err'
        if numish1Rttb>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x53,1,fa):
                    strout+=',ish1Rttb-OK'
                else:
                    strout+=',ish1Rttb-Err'
        if numish1M>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x54,1,fa):
                    strout+=',ish1M-OK'
                else:
                    strout+=',ish1M-Err'
        ...
        if numish2C0>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x55,1,fa):
                    strout+=',ish2C0-OK'
                else:
                    strout+=',ish2C0-Err'
        if numish2C1>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x56,1,fa):
                    strout+=',ish2C1-OK'
                else:
                    strout+=',ish2C1-Err'
        if numish2C2>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x57,1,fa):
                    strout+=',ish2C2-OK'
                else:
                    strout+=',ish2C2-Err'
        if numish2C3>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x58,1,fa):
                    strout+=',ish2C3-OK'
                else:
                    strout+=',ish2C3-Err'
        if numish2C4>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x59,1,fa):
                    strout+=',ish2C4-OK'
                else:
                    strout+=',ish2C4-Err'
        if numish2C5>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x5a,1,fa):
                    strout+=',ish2C5-OK'
                else:
                    strout+=',ish2C5-Err'
        if numish2C6>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x5b,1,fa):
                    strout+=',ish2C6-OK'
                else:
                    strout+=',ish2C6-Err'
        if numish2C7>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x5c,1,fa):
                    strout+=',ish2C7-OK'
                else:
                    strout+=',ish2C7-Err'
        if numish2C8>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x5d,1,fa):
                    strout+=',ish2C8-OK'
                else:
                    strout+=',ish2C8-Err'
        if numish2C9>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x5e,1,fa):
                    strout+=',ish2C9-OK'
                else:
                    strout+=',ish2C9-Err'
        ...
        if numish3tPPOZn>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x60,1,fa):
        ...
        if numish3tPPOAl>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x61,1,fa):
        ...
        if numish3tPPOCu>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x62,1,fa):
        ...
        if numish3uPPOZn>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x63,1,fa):
        ...
        if numish3uPPOAl>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x64,1,fa):
        ...
        if numish3tPPOCu>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x65,1,fa):
        ...
        if numish4tPROAl>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x66,1,fa):
        ...
        if numish4tPROCu>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x67,1,fa):
        ...
        if numish4tPROPd>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x68,1,fa):
        ...
        if numish4tPROPt>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x69,1,fa):
        ...
        if numish4uPROAl>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x6a,1,fa):
        ...
        if numish4uPROCu>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x6b,1,fa):
        ...
        if numish4uPROPd>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x6c,1,fa):
        ...
        if numish4uPROPt>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x6d,1,fa):
        ...
        if numstartmeas>-1:
            fa[0]=1.0
            if WriteFloatMBus(portname,boud,0x4d,0x111,1,fa):
                strout+=',startmeas-OK'
            else:
        ...
        if numstopmeas>-1:
            fa[0]=1.0
            if WriteFloatMBus(portname,boud,0x4d,0x110,1,fa):
                strout+=',stopmeas-OK'
            else:
                strout+=',stopmeas-Err'
        ...
        if numzerocalibr>-1:
            fa[0]=1.0
            if WriteFloatMBus(portname,boud,0x4d,0x112,1,fa):
