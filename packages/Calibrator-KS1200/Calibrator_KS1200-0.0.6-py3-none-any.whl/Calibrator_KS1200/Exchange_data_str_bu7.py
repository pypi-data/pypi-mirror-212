...
str_change=None
strout=None
def exchange_data_bu7(str_received, # строка с командами для выполнения
    ...
    if str_change[0]=='R':  #read data
        ...
        if numcentralTmpcorr1>-1 or numcentralTmpcorr2>-1 or numcentralTmpcorr3>-1 or numcentralTmpcorr4>-1 or numcentralTmpcorr5>-1:
            inbuff=ReadFloatMBus(portname,boud,1,278*2,5) # modbusnum = 1, addres = 278*2, numfloat = 5
            if inbuff:
        ...
        if numuppTmpcorr1>-1 or numuppTmpcorr2>-1 or numuppTmpcorr3>-1 or numuppTmpcorr4>-1 or numuppTmpcorr5>-1 or numdownTmpcorr1>-1 or numdownTmpcorr2>-1 or numdownTmpcorr3>-1 or numdownTmpcorr4>-1 or numdownTmpcorr5>-1: 
            inbuff=ReadFloatMBus(portname,boud,1,190*2,10)
            if inbuff: 
                if numuppTmpcorr1>-1:
        ...
        if numpolicoeff1>-1 or numpolicoeff2>-1 or numpolicoeff3>-1:
            inbuff=ReadFloatMBus(portname,boud,1,180*2,3)
            if inbuff:
                if numpolicoeff1>-1:
        ...
        if numT1>-1 or numT2>-1 or numT3>-1 or numP1>-1 or numP2>-1 or numP3>-1 or numPi1>-1 or numPi2>-1 or numPi3>-1 or numon1>-1 or numon2>-1 or numon3>-1:
            inbuff=ReadFloatMBus(portname,boud,1,20000,12)
            if inbuff:
                if numT1>-1:
        ...
        if numTs1>-1 or numTs2>-1 or numTs3>-1:
            inbuff=ReadFloatMBus(portname,boud,1,10*2,3)
            if inbuff:
                if numTs1>-1:
        ...
        if numkp1>-1 or numkp2>-1 or numkp3>-1 or numki1>-1 or numki2>-1 or numki3>-1 or numkd1>-1 or numkd2>-1 or numkd3>-1:
            inbuff=ReadFloatMBus(portname,boud,1,206*2,9)
            if inbuff: 
                if numkp1>-1:
        ...
        if numPimax1>-1 or numPimax2>-1 or numPimax3>-1 or numPimin1>-1 or numPimin2>-1 or numPimin3>-1 or numkpmax1>-1 or numkpmax2>-1 or numkpmax3>-1 or numTmax1>-1 or numTmax2>-1 or numTmax3>-1 or numTmin1>-1 or numTmin2>-1 or numTmin3 >-1:
            inbuff=ReadFloatMBus(portname,boud,1,215*2,15)
            if inbuff:
                if numPimax1>-1:
        ...
        if numkpcalc1>-1 or numkpcalc2>-1 or numkpcalc3>-1:
            inbuff=ReadFloatMBus(portname,boud,1,112*2,15)
            if inbuff:
                if numkpcalc1>-1:
        ...
        if numdevtype>-1 or numcalpr>-1 or numpowset>-1 :
            inbuff=ReadBytesMBus(portname,boud,1,0x400,4)
            if inbuff:
                if numdevtype>-1:
        ...
        if numcentralTmpcorr1>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,1,278*2,1,fa): 
        ...
        if numcentralTmpcorr2>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,1,279*2,1,fa): 
        ...
        if numcentralTmpcorr3>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,1,280*2,1,fa): 
        ...
        if numcentralTmpcorr4>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,1,281*2,1,fa): 
        ...
        if numcentralTmpcorr5>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,1,282*2,1,fa): 
        ...
        if numdownTmpcorr1>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,1,191*2,1,fa): 
        ...
        if numdownTmpcorr2>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,1,193*2,1,fa): 
        ...
        if numdownTmpcorr3>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,1,195*2,1,fa): 
        ...
        if numdownTmpcorr4>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,1,197*2,1,fa): 
        ...
        if numdownTmpcorr5>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,1,199*2,1,fa): 
        ...
        if numuppTmpcorr1>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,1,190*2,1,fa): 
        ...
        if numuppTmpcorr2>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,1,192*2,1,fa): 
        ...
        if numuppTmpcorr1>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,1,194*2,1,fa): 
        ...
        if numuppTmpcorr1>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,1,196*2,1,fa): 
        ...
        if numuppTmpcorr1>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,1,198*2,1,fa): 
        ...
        if numpolicoeff1>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,1,180*2,1,fa): 
        ...
        if numpolicoeff2>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,1,181*2,1,fa): 
        ...
        if numpolicoeff3>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,1,182*2,1,fa): 
        ...
        if numTs1>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,1,10*2,1,fa): 
                    strout+=',Ts1-OK'
                else:
                    strout+=',Ts1-Err'
        ...
        if numTs2>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,1,11*2,1,fa):
                    strout+=',Ts2-OK'
                else:
                    strout+=',Ts2-Err'
        if numTs3>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,1,12*2,1,fa): 
                    strout+=',Ts3-OK'
                else:
                    strout+=',Ts3-Err'
        ...
        if numkp1>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval   
                if WriteFloatMBus(portname,boud,1,206*2,1,fa): 
                    strout+=',kp1-OK'
                else:
                    strout+=',hp1-Err'
        if numkp2>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval   
                if WriteFloatMBus(portname,boud,1,207*2,1,fa): 
                    strout+=',kp2-OK'
                else:
                    strout+=',hp2-Err'
        if numkp3>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval   
                if WriteFloatMBus(portname,boud,1,208*2,1,fa): 
                    strout+=',kp3-OK'
                else:
                    strout+=',hp3-Err'
        if numki1>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval   
                if WriteFloatMBus(portname,boud,1,209*2,1,fa): 
                    strout+=',ki1-OK'
                else:
                    strout+=',ki1-Err'
        ...
        if numki2>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval   
                if WriteFloatMBus(portname,boud,1,210*2,1,fa): 
                    strout+=',ki2-OK'
                else:
                    strout+=',ki2-Err'
        ...
        if numki3>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval   
                if WriteFloatMBus(portname,boud,1,211*2,1,fa): 
                    strout+=',ki3-OK'
                else:
                    strout+=',ki3-Err'
        ...
        if numkd1>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval   
                if WriteFloatMBus(portname,boud,1,212*2,1,fa):
                    strout+=',kd1-OK'
                else:
                    strout+=',kd1-Err'
        ...
        if numkd2>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval   
                if WriteFloatMBus(portname,boud,1,213*2,1,fa): 
                    strout+=',kd2-OK'
                else:
                    strout+=',kd2-Err'
        ...
        if numkd3>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval   
                if WriteFloatMBus(portname,boud,1,214*2,1,fa): 
                    strout+=',kd3-OK'
                else:
                    strout+=',kd3-Err'
        ...
        if numPimax1>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval   
                if WriteFloatMBus(portname,boud,1,215*2,1,fa): 
                    strout+=',Pimax1-OK'
                else:
                    strout+=',Pimax1-Err'
        ...
        if numPimax2>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval   
                if WriteFloatMBus(portname,boud,1,216*2,1,fa): 
                    strout+=',Pimax2-OK'
                else:
                    strout+=',Pimax2-Err'
        ...
        if numPimax3>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval   
                if WriteFloatMBus(portname,boud,1,217*2,1,fa): 
                    strout+=',Pimax3-OK'
                else:
                    strout+=',Pimax3-Err'
        ...
        if numPimin1>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval   
                if WriteFloatMBus(portname,boud,1,218*2,1,fa): 
                    strout+=',Pimin1-OK'
                else:
                    strout+=',Pimin1-Err'
        ...
        if numPimin2>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval   
                if WriteFloatMBus(portname,boud,1,219*2,1,fa): 
                    strout+=',Pimin2-OK'
                else:
                    strout+=',Pimin2-Err'
        ...
        if numPimin3>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval   
                if WriteFloatMBus(portname,boud,1,220*2,1,fa): 
                    strout+=',Pimin3-OK'
                else:
                    strout+=',Pimin3-Err'
        ...
        if numkpmax1>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval   
                if WriteFloatMBus(portname,boud,1,221*2,1,fa): 
                    strout+=',kpmax1-OK'
                else:
                    strout+=',kpmax1-Err'
        ...
        if numkpmax2>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval   
                if WriteFloatMBus(portname,boud,1,222*2,1,fa): 
                    strout+=',kpmax2-OK'
                else:
                    strout+=',kpmax2-Err'
        ...
        if numkpmax3>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval  
                if WriteFloatMBus(portname,boud,1,223*2,1,fa): 
                    strout+=',kpmax3-OK'
                else:
                    strout+=',kpmax3-Err'
        ...
        if numTmax1>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval   
                if WriteFloatMBus(portname,boud,1,224*2,1,fa): 
                    strout+=',Tmax1-OK'
                else:
                    strout+=',Tmax1-Err'
        ...
        if numTmax2>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval   
                if WriteFloatMBus(portname,boud,1,225*2,1,fa): 
                    strout+=',Tmax2-OK'
                else:
                    strout+=',Tmax2-Err'
        ...
        if numTmax3>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval   
                if WriteFloatMBus(portname,boud,1,226*2,1,fa): 
                    strout+=',Tmax3-OK'
                else:
                    strout+=',Tmax3-Err'
        ...
        if numTmin1>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval   
                if WriteFloatMBus(portname,boud,1,227*2,1,fa): 
                    strout+=',Tmin1-OK'
                else:
                    strout+=',Tmin1-Err'
        ...
        if numTmin2>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval   
                if WriteFloatMBus(portname,boud,1,228*2,1,fa): 
                    strout+=',Tmin2-OK'
                else:
                    strout+=',Tmin2-Err'
        ...
        if numTmin3>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0] = parval   
                if WriteFloatMBus(portname,boud,1,229*2,1,fa): 
                    strout+=',Tmin3-OK'
                else:
                    strout+=',Tmin3-Err'
        ...
        if numpowset>-1:
            ...
            if numpowset>-1:
                ...
                if par=='ON':
                    inbuff[3]=0x05
                    if WriteFourBytesMBus(portname,boud,1,0x400,4,inbuff):
                        strout+=',powset-OK'
