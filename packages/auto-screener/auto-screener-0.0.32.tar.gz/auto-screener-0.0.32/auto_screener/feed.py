...
class MarketRecorder:
    ...
    def data(self, source: str, ticker: str) -> pd.DataFrame:
        """
        Returns the market data of the ticker from the exchange.

        :param source: The source name of the exchange.
        :param ticker: The ticker of the pair.

        :return: The dataset of the spread data.
        """

        exchange = self.market[
            find_name(name=source, names=self.market.keys())
        ]

        return exchange[find_name(name=ticker, names=exchange.keys())]
    # end data
    ...
    def screener(
        ...
        source = find_name(name=source, names=self.market.keys())
        ...
        ticker = find_name(name=ticker, names=self.market[source].keys())
