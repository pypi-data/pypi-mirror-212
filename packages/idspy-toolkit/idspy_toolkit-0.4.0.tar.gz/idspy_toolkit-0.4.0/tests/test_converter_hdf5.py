...
from idspy_toolkit.converter import ids_to_hdf5, get_inner_type_list, hdf5_to_ids
...
test_class = [
    (Class1, ("Class1", "Class1/time")),
    (Class3, ("Class3", "Class3/time", "Class3/space", "Class3/name")),
    (ClassList, ("ClassList", "ClassList/time")),
    (ClassList2, ("ClassList2", "ClassList2/time")),
    (ClassListMix, ("ClassListMix", "ClassListMix/name", "ClassListMix/space", "ClassListMix/time")),
    ...
    (ClassListNestedList, ("ClassListNestedList",
                           "ClassListNestedList/nestedclass#0000",
                           "ClassListNestedList/nestedclass#0000/jsonarg1_0",
                           "ClassListNestedList/nestedclass#0000/jsonarg1_1",
                           "ClassListNestedList/nestedclass#0000/name1",
                           "ClassListNestedList/nestedclass#0000/space1",
                           "ClassListNestedList/nestedclass#0000/time1",
                           "ClassListNestedList/nestedclass#0001",
                           "ClassListNestedList/nestedclass#0001/jsonarg1_0",
                           "ClassListNestedList/nestedclass#0001/jsonarg1_1",
                           "ClassListNestedList/nestedclass#0001/name1",
                           "ClassListNestedList/nestedclass#0001/space1",
                           "ClassListNestedList/nestedclass#0001/time1",
