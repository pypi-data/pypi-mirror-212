...
-----
<ul>
  <li>At this time, this module is limited and and does not attempt
...
class AccessInformation:
    ...
    def acknowledgement(self, value: str):
        ...
        """
    @staticmethod
    def get_access_information(spase: ET) -> List[AccessInformation]:

        Produces the AccessInformation objects from the given spase
        document.

        Parameters
        ----------
        spase
            spase document to get AccessInformation objects from.
        Returns
        -------
        List
            of AccessInformation objects.
        Raises
        ------
        ValueError
            If the given spase does not contain any AccessInformation 
            objects ??? or just return an empty list
