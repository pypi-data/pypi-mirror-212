...
def validate_version_and_branch(branch: Optional[str], commit_sha1: Optional[str]) -> None:
    ...
    """
    package_name, _ = get_package_and_version()
    version = "3.6.8"
    ...
    try:
        ...
        if "." in latest and "." in version:
            ...
            recommended_upgrade_msg = \
                f"CVL2 is out! You are using {package_name} version {version}; however, version {latest}" \
                " is available. You can learn more about CVL2 here:" \
                " https://docs.certora.com/en/latest/docs/cvl/cvl2/changes.html" \
                f" Once you migrated your specs to CVL2, it is recommended to upgrade by running: {installation_cmd}"
