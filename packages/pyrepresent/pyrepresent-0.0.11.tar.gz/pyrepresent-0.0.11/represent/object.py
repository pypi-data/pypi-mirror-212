...
from typing import (
    Any, Optional, Union, Iterable, Type, Dict, Self, Tuple
)
...
class HashableDict(dict):
    ...
    def __eq__(self, other: Self) -> bool:
        ...
        return (
            ...
            (self.__signature == other.__signature)
        )
    # end __eq__
    ...
    @property
    def __signature(self) -> Tuple[Tuple[Any, Any], ...]:
        """
    ...
    def __immutable(self, *args: Any, **kwargs: Any) -> None:
        """
