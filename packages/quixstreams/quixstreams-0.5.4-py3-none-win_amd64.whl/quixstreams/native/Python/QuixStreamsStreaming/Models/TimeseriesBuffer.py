...
class TimeseriesBuffer(object):
    ...
    def add_OnDataReleased(self, value: Callable[[c_void_p, c_void_p], None]) -> None:
        """
        Parameters
        ----------
        ...
        InteropUtils.invoke("timeseriesbuffer_add_ondatareleased", self._pointer, value_func_wrapper_addr)
    ...
    _interop_func.restype = None
    _interop_func.argtypes = [c_void_p, c_void_p]
    def remove_OnDataReleased(self, value: Callable[[c_void_p, c_void_p], None]) -> None:
        """
        Parameters
        ----------
        ...
        if value is not None:
            ...
            value_func_wrapper_addr = ctypes.cast(value_converter_func_wrapper, c_void_p)
            if InteropUtils.DebugEnabled:
                print("Registering value_converter_func_wrapper in timeseriesbuffer_remove_ondatareleased, addr {}".format(value_func_wrapper_addr))
                value_func_wrapper_addr_val = value_func_wrapper_addr.value
                # TODO TimeseriesBuffer._weakrefs.append(weakref.ref(value_converter_func_wrapper, lambda x: print("De-referenced value_converter_func_wrapper in timeseriesbuffer_remove_ondatareleased, addr {}".format(value_func_wrapper_addr_val))))
        
        InteropUtils.invoke("timeseriesbuffer_remove_ondatareleased", self._pointer, value_func_wrapper_addr)
        return value_func_wrapper_addr
    ...
    _interop_func.restype = None
    _interop_func.argtypes = [c_void_p, c_void_p]
    def add_OnRawReleased(self, value: Callable[[c_void_p, c_void_p], None]) -> None:
        """
        Parameters
        ----------
        ...
        InteropUtils.invoke("timeseriesbuffer_add_onrawreleased", self._pointer, value_func_wrapper_addr)
        return value_func_wrapper_addr
    ...
    _interop_func.restype = None
    _interop_func.argtypes = [c_void_p, c_void_p]
    def remove_OnRawReleased(self, value: Callable[[c_void_p, c_void_p], None]) -> None:
        """
        Parameters
        ----------
        ...
        if value is not None:
            ...
            value_func_wrapper_addr = ctypes.cast(value_converter_func_wrapper, c_void_p)
            if InteropUtils.DebugEnabled:
                print("Registering value_converter_func_wrapper in timeseriesbuffer_remove_onrawreleased, addr {}".format(value_func_wrapper_addr))
                value_func_wrapper_addr_val = value_func_wrapper_addr.value
                # TODO TimeseriesBuffer._weakrefs.append(weakref.ref(value_converter_func_wrapper, lambda x: print("De-referenced value_converter_func_wrapper in timeseriesbuffer_remove_onrawreleased, addr {}".format(value_func_wrapper_addr_val))))
        
        InteropUtils.invoke("timeseriesbuffer_remove_onrawreleased", self._pointer, value_func_wrapper_addr)
        return value_func_wrapper_addr
