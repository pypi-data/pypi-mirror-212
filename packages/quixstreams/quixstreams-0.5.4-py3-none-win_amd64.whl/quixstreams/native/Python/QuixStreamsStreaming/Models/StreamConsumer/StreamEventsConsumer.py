...
class StreamEventsConsumer(object):
    ...
    def add_OnDataReceived(self, value: Callable[[c_void_p, c_void_p], None]) -> None:
        ...
        InteropUtils.invoke("streameventsconsumer_add_ondatareceived", self._pointer, value_func_wrapper_addr)
    ...
    def remove_OnDataReceived(self, value: Callable[[c_void_p, c_void_p], None]) -> None:
        ...
        if value is not None:
            ...
            value_func_wrapper_addr = ctypes.cast(value_converter_func_wrapper, c_void_p)
            if InteropUtils.DebugEnabled:
                print("Registering value_converter_func_wrapper in streameventsconsumer_remove_ondatareceived, addr {}".format(value_func_wrapper_addr))
                value_func_wrapper_addr_val = value_func_wrapper_addr.value
                # TODO StreamEventsConsumer._weakrefs.append(weakref.ref(value_converter_func_wrapper, lambda x: print("De-referenced value_converter_func_wrapper in streameventsconsumer_remove_ondatareceived, addr {}".format(value_func_wrapper_addr_val))))
        
        InteropUtils.invoke("streameventsconsumer_remove_ondatareceived", self._pointer, value_func_wrapper_addr)
        return value_func_wrapper_addr
    ...
    def add_OnDefinitionsChanged(self, value: Callable[[c_void_p, c_void_p], None]) -> None:
        ...
        InteropUtils.invoke("streameventsconsumer_add_ondefinitionschanged", self._pointer, value_func_wrapper_addr)
        return value_func_wrapper_addr
    ...
    def remove_OnDefinitionsChanged(self, value: Callable[[c_void_p, c_void_p], None]) -> None:
        ...
        if value is not None:
            ...
            value_func_wrapper_addr = ctypes.cast(value_converter_func_wrapper, c_void_p)
            if InteropUtils.DebugEnabled:
                print("Registering value_converter_func_wrapper in streameventsconsumer_remove_ondefinitionschanged, addr {}".format(value_func_wrapper_addr))
                value_func_wrapper_addr_val = value_func_wrapper_addr.value
                # TODO StreamEventsConsumer._weakrefs.append(weakref.ref(value_converter_func_wrapper, lambda x: print("De-referenced value_converter_func_wrapper in streameventsconsumer_remove_ondefinitionschanged, addr {}".format(value_func_wrapper_addr_val))))
        
        InteropUtils.invoke("streameventsconsumer_remove_ondefinitionschanged", self._pointer, value_func_wrapper_addr)
        return value_func_wrapper_addr
