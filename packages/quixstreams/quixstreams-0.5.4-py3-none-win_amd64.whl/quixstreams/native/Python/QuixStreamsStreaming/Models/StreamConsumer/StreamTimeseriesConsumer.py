...
class StreamTimeseriesConsumer(object):
    ...
    _interop_func.argtypes = [c_void_p, c_void_p]
    def add_OnDefinitionsChanged(self, value: Callable[[c_void_p, c_void_p], None]) -> None:
        """
        Parameters
        ----------
        ...
        InteropUtils.invoke("streamtimeseriesconsumer_add_ondefinitionschanged", self._pointer, value_func_wrapper_addr)
    ...
    _interop_func.restype = None
    _interop_func.argtypes = [c_void_p, c_void_p]
    def remove_OnDefinitionsChanged(self, value: Callable[[c_void_p, c_void_p], None]) -> None:
        """
        Parameters
        ----------
        ...
        if value is not None:
            ...
            value_func_wrapper_addr = ctypes.cast(value_converter_func_wrapper, c_void_p)
            if InteropUtils.DebugEnabled:
                print("Registering value_converter_func_wrapper in streamtimeseriesconsumer_remove_ondefinitionschanged, addr {}".format(value_func_wrapper_addr))
                value_func_wrapper_addr_val = value_func_wrapper_addr.value
                # TODO StreamTimeseriesConsumer._weakrefs.append(weakref.ref(value_converter_func_wrapper, lambda x: print("De-referenced value_converter_func_wrapper in streamtimeseriesconsumer_remove_ondefinitionschanged, addr {}".format(value_func_wrapper_addr_val))))
        
        InteropUtils.invoke("streamtimeseriesconsumer_remove_ondefinitionschanged", self._pointer, value_func_wrapper_addr)
        return value_func_wrapper_addr
    ...
    _interop_func.restype = None
    _interop_func.argtypes = [c_void_p, c_void_p]
    def add_OnDataReceived(self, value: Callable[[c_void_p, c_void_p], None]) -> None:
        """
        Parameters
        ----------
        ...
        InteropUtils.invoke("streamtimeseriesconsumer_add_ondatareceived", self._pointer, value_func_wrapper_addr)
        return value_func_wrapper_addr
    ...
    _interop_func.restype = None
    _interop_func.argtypes = [c_void_p, c_void_p]
    def remove_OnDataReceived(self, value: Callable[[c_void_p, c_void_p], None]) -> None:
        """
        Parameters
        ----------
        ...
        if value is not None:
            ...
            value_func_wrapper_addr = ctypes.cast(value_converter_func_wrapper, c_void_p)
            if InteropUtils.DebugEnabled:
                print("Registering value_converter_func_wrapper in streamtimeseriesconsumer_remove_ondatareceived, addr {}".format(value_func_wrapper_addr))
                value_func_wrapper_addr_val = value_func_wrapper_addr.value
                # TODO StreamTimeseriesConsumer._weakrefs.append(weakref.ref(value_converter_func_wrapper, lambda x: print("De-referenced value_converter_func_wrapper in streamtimeseriesconsumer_remove_ondatareceived, addr {}".format(value_func_wrapper_addr_val))))
        
        InteropUtils.invoke("streamtimeseriesconsumer_remove_ondatareceived", self._pointer, value_func_wrapper_addr)
        return value_func_wrapper_addr
    ...
    _interop_func.restype = None
    _interop_func.argtypes = [c_void_p, c_void_p]
    def add_OnRawReceived(self, value: Callable[[c_void_p, c_void_p], None]) -> None:
        """
        Parameters
        ----------
        ...
        InteropUtils.invoke("streamtimeseriesconsumer_add_onrawreceived", self._pointer, value_func_wrapper_addr)
        return value_func_wrapper_addr
    ...
    _interop_func.restype = None
    _interop_func.argtypes = [c_void_p, c_void_p]
    def remove_OnRawReceived(self, value: Callable[[c_void_p, c_void_p], None]) -> None:
        """
        Parameters
        ----------
        ...
        if value is not None:
            ...
            value_func_wrapper_addr = ctypes.cast(value_converter_func_wrapper, c_void_p)
            if InteropUtils.DebugEnabled:
                print("Registering value_converter_func_wrapper in streamtimeseriesconsumer_remove_onrawreceived, addr {}".format(value_func_wrapper_addr))
                value_func_wrapper_addr_val = value_func_wrapper_addr.value
                # TODO StreamTimeseriesConsumer._weakrefs.append(weakref.ref(value_converter_func_wrapper, lambda x: print("De-referenced value_converter_func_wrapper in streamtimeseriesconsumer_remove_onrawreceived, addr {}".format(value_func_wrapper_addr_val))))
        
        InteropUtils.invoke("streamtimeseriesconsumer_remove_onrawreceived", self._pointer, value_func_wrapper_addr)
        return value_func_wrapper_addr
