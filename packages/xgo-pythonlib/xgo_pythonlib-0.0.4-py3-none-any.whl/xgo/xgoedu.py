...
class XGOEDU():
    def __init__(self):
        ...
        self.font = ImageFont.truetype("Font/msyh.ttc",15)
        self.key1=17
        self.key2=22
        self.key3=23
        self.key4=24
    ...
    def lcd_text(self,x,y,content,color="WHITE",fontsize=15):
        if fontsize!=15:
            self.font = ImageFont.truetype("Font/msyh.ttc",fontsize)
    ...
    def cameraOn(self,filename="camera"):
        font = ImageFont.truetype("Font/msyh.ttc",20)
        self.open_camera()
        while True:
