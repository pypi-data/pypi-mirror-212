...
def test_copy_dir_nested_files_and_subdirs():
    ...
    try:
        ...
        temp_subdir = os.path.join(base_rsrc_dir, 'subdir')
        os.makedirs(temp_subdir)
        temp_file1 = os.path.join(base_rsrc_dir, 'file1.txt')
        temp_file2 = os.path.join(temp_subdir, 'file2.txt')
        ...
        assert os.path.exists(os.path.join(sensi_rsrc_dir, 'subdir', 'file2.txt'))
        assert os.path.isfile(os.path.join(sensi_rsrc_dir, 'file1.txt'))
        assert os.path.isfile(os.path.join(sensi_rsrc_dir, 'subdir', 'file2.txt'))
    finally:
