    ...
    createNew(panel) {
        ...
        const toggleAssistant = () => {
            ...
            if (findAssistant()) {
                ...
                _jupyterlab_notebook__WEBPACK_IMPORTED_MODULE_3__.NotebookActions.deleteCells(panel.content);
            }
            else {
                initAssistant();
            }
        ...
        panel.sessionContext.ready.then(() => {
            var _a;
            button.enabled = true;
            if (!findAssistant() && !((_a = panel.content.model) === null || _a === void 0 ? void 0 : _a.metadata.get("dca-init"))) {
                initAssistant();
            }
        });
...
const plugin = {
    ...
    activate: (app, NotebookTracker) => {
        ...
        const DCA = { frontend: 'lab', toArray: _lumino_algorithm__WEBPACK_IMPORTED_MODULE_4__.toArray, toObject: _lumino_algorithm__WEBPACK_IMPORTED_MODULE_4__.toObject, getNotebookId, getCells, assistants, changeCellType, insertCellAbove, insertCellsBelow, runAndAdvance, getNotebookPath, saveNotebook, activate, kernelBusy };
        window["DCA"] = DCA;
...
//# sourceMappingURL=lib_index_js.17fb0f6444808f681a48.js.map