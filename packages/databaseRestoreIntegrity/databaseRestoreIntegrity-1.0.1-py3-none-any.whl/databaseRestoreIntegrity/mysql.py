...
class mysqlRestroeCheck:
    ...
    def _create_tmp_table(self, name):
        ...
        ct.execute("{}{}{}".format('CREATE TABLE IF NOT EXISTS ', self.name, ' (tables_name VARCHAR(255), records_count VARCHAR(255))'))
        for data in records:
            sql_query = ("{}{}{}{}".format('INSERT INTO ', self.name, ' (tables_name, records_count) VALUES ', (data.split(",")[0], data.split(",")[1])))
