...
def getListOfCompartmentGlyphs(document, compartmentId):
    return _libsbmlnetworkeditor.getListOfCompartmentGlyphs(document, compartmentId)
...
def getListOfSpeciesGlyphs(document, speciesId):
    return _libsbmlnetworkeditor.getListOfSpeciesGlyphs(document, speciesId)
...
def getListOfReactionGlyphs(document, reactionId):
    return _libsbmlnetworkeditor.getListOfReactionGlyphs(document, reactionId)
