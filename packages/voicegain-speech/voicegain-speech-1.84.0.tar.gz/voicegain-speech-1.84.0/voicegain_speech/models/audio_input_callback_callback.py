...
class AudioInputCallbackCallback(object):
    ...
    def __init__(self, auth_conf=None, method=None, multipart_form_data=None, uri=None, local_vars_configuration=None):  # noqa: E501
        """AudioInputCallbackCallback - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def auth_conf(self):
        """Gets the auth_conf of this AudioInputCallbackCallback.  # noqa: E501

        Name of the authentication config for accessing the URI, if missing then no authentication will be attempted. Can be defined via Voicegain Console.  For details see this [Knowledge Base article](https://support.voicegain.ai/hc/en-us/articles/4408977638292-Using-authConf-for-Callbacks).   # noqa: E501

        :return: The auth_conf of this AudioInputCallbackCallback.  # noqa: E501
        :rtype: str
        """
    ...
    def auth_conf(self, auth_conf):
        """Sets the auth_conf of this AudioInputCallbackCallback.

        Name of the authentication config for accessing the URI, if missing then no authentication will be attempted. Can be defined via Voicegain Console.  For details see this [Knowledge Base article](https://support.voicegain.ai/hc/en-us/articles/4408977638292-Using-authConf-for-Callbacks).   # noqa: E501

        :param auth_conf: The auth_conf of this AudioInputCallbackCallback.  # noqa: E501
        :type: str
        """
    ...
    def multipart_form_data(self):
        """Gets the multipart_form_data of this AudioInputCallbackCallback.  # noqa: E501

        If present and `method` is either POST or PUT then will submit the callback data as multipart/form-data. One of the data fields will be named **file** and will contain the audio data. The **filename** value in that field will be equal to the **sessionId**   # noqa: E501

        :return: The multipart_form_data of this AudioInputCallbackCallback.  # noqa: E501
    ...
    def multipart_form_data(self, multipart_form_data):
        """Sets the multipart_form_data of this AudioInputCallbackCallback.

        If present and `method` is either POST or PUT then will submit the callback data as multipart/form-data. One of the data fields will be named **file** and will contain the audio data. The **filename** value in that field will be equal to the **sessionId**   # noqa: E501

        :param multipart_form_data: The multipart_form_data of this AudioInputCallbackCallback.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AudioInputCallbackCallback):
            return False
