...
def GenerateCorrectAnswerMatrix(Correct_answer_dict,Rectangle_Shape,ignore_nrows=2):
    ...
    for key in Correct_answer_dict:
        ...
        #print(key,column)
        correct_answer_matrix[key+(ignore_nrows-1), column] = 1
...
def ReadCorrectAnswer(xlsxFN, nrows=12, usecols='A:M', Print=False):
    ...
    return TF_ind_set1, TF_ind_set2, TF_ind_set3, QA_ind_set1, QA_ind_set2, QA_ind_set3, Mark_correctAnswer_TF, Mark_wrongAnswer_TF, Mark_CorrectAnswer_QA, Mark_wrongAnswer_QA
