...
SERVICE_NAME: str = "floodingbot"
SERVICE_DISPLAY_NAME: str = "FloodingBot"


class EmewsServiceFloodingbot(ConfigService):
    ...
    default_configs: List[Configuration] = [
        ConfigString(id="emews_service_config", label="Service Configuration",
                     options=["default", "udp_flooder1", "tcp_botnet_cc3", "udp_botnet_cc3", "tcp_botnet_cc2", "udp_bot2", "tcp_botnet_cc", "tcp_bot2", "udp_botnet_cc", "udp_bot", "tcp_bot"], default="default"),
    ]
