...
SERVICE_NAME: str = "sitecrawler"
SERVICE_DISPLAY_NAME: str = "SiteCrawler"


class EmewsServiceSitecrawler(ConfigService):
    ...
    default_configs: List[Configuration] = [
        ConfigString(id="emews_service_config", label="Service Configuration",
                     options=["default", "ts2-2", "ts2-1", "agent", "ts2-3"], default="default"),
    ]
