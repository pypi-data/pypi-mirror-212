...
SERVICE_NAME: str = "EMEWS_SERVICE_NAME"
SERVICE_DISPLAY_NAME: str = "EMEWS_SERVICE_DISPLAY_NAME"


class EmewsServiceEMEWS_CLASS_NAME(ConfigService):
    ...
    default_configs: List[Configuration] = [
        ConfigString(id="emews_service_config", label="Service Configuration",
                     options=["defaultEMEWS_SERVICE_CONFIGS"], default="default"),
    ]
