...
SERVICE_NAME: str = "helloworld"
SERVICE_DISPLAY_NAME: str = "HelloWorld"


class EmewsServiceHelloworld(ConfigService):
    ...
    default_configs: List[Configuration] = [
        ConfigString(id="emews_service_config", label="Service Configuration",
                     options=["default", "distworldserver", "distworldclient"], default="default"),
    ]
