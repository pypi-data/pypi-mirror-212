...
def plot_first_main_paths(myPathAnalysis, path_column='mypath', id_column='travelid', nb_paths=15, print_query=False,
    ...
    if justify == 'left':
        ...
        ascending     = ''
        init          = '0'
    elif justify == 'right_1':
        justify_query = '''max_path_length - AAA.id_end_temp as id_end'''
        ascending     = ' DESC'
        init          = 'max_path_length'
    elif justify == 'right_2':
        justify_query = '''AAA.id_end_temp as id_end'''
        ascending = ' DESC'
        init = 'max_path_length'
    elif justify == 'right_3':
        justify_query = '''max_path_length - AAA.id_end_temp as id_end'''
        ascending     = ' '
        init          = 'max_path_length'
    elif justify == 'right_4':
        justify_query = '''AAA.id_end_temp as id_end'''
        ascending = ' '
        init = 'max_path_length'
    elif justify == 'right_5':
        justify_query = '''max_path_length - AAA.id_end_temp as id_end'''
        ascending     = ' DESC'
        init          = '1'
    elif justify == 'right_6':
        justify_query = '''AAA.id_end_temp as id_end'''
        ascending = ' DESC'
        init = '1'
    elif justify == 'right_7':
        justify_query = '''max_path_length - AAA.id_end_temp as id_end'''
        ascending     = ' '
        init          = '1'
    elif justify == 'right_8':
        justify_query = '''AAA.id_end_temp as id_end'''
        ascending = ' '
        init = '1'
    elif justify == 'both':
