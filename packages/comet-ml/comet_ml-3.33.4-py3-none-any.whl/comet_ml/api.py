...
from comet_ml import api_objects
...
class API(object):
    ...
    * API.get_experiments(WORKSPACE, PROJECT_NAME, PATTERN): get all APIExperiments in WORKSPACE/PROJECT/PATTERN
    ...
    def get_model(self, workspace, model_name) -> api_objects.model.Model:
        """
        ...
        """
        return api_objects.model.Model.from_registry(
            workspace, model_name, api_key=self.api_key
        )
