...
class OrganizationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListOrganizationUsers = channel.unary_unary(
                ...
                response_deserializer=organization__service__pb2.ListOrganizationUsersResponse.FromString,
                )
...
def add_OrganizationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ListOrganizationUsers': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=organization__service__pb2.ListOrganizationUsersResponse.SerializeToString,
            ),
...
class OrganizationService(object):
    ...
    def ListOrganizationUsers(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/calixa.domain.organization.OrganizationService/ListOrganizationUsers',
            organization__service__pb2.ListOrganizationUsersRequest.SerializeToString,
            organization__service__pb2.ListOrganizationUsersResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
