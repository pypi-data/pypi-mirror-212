...
class NoteServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SaveThread = channel.unary_unary(
                ...
                request_serializer=collaboration__entity__pb2.Thread.SerializeToString,
                response_deserializer=collaboration__entity__pb2.Thread.FromString,
                )
        self.GetAssociatedThreads = channel.unary_unary(
                ...
                response_deserializer=collaboration__pb2.GetAssociatedThreadsResponse.FromString,
                )
        self.SaveMessage = channel.unary_unary(
                '/calixa.domain.collaboration.NoteService/SaveMessage',
                request_serializer=collaboration__entity__pb2.Message.SerializeToString,
                response_deserializer=collaboration__entity__pb2.Message.FromString,
                )
        self.GetThread = channel.unary_unary(
                '/calixa.domain.collaboration.NoteService/GetThread',
        ...
        self.GetMessages = channel.unary_unary(
                ...
                response_deserializer=collaboration__pb2.GetMessageResponse.FromString,
                )
...
def add_NoteServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SaveThread': grpc.unary_unary_rpc_method_handler(
                    servicer.SaveThread,
                    request_deserializer=collaboration__entity__pb2.Thread.FromString,
                    response_serializer=collaboration__entity__pb2.Thread.SerializeToString,
            ),
            'GetAssociatedThreads': grpc.unary_unary_rpc_method_handler(
                    servicer.GetAssociatedThreads,
                    request_deserializer=collaboration__pb2.GetAssociatedThreadsRequest.FromString,
                    response_serializer=collaboration__pb2.GetAssociatedThreadsResponse.SerializeToString,
            ),
            'SaveMessage': grpc.unary_unary_rpc_method_handler(
                    servicer.SaveMessage,
                    request_deserializer=collaboration__entity__pb2.Message.FromString,
            ...
            'GetMessages': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=collaboration__pb2.GetMessageResponse.SerializeToString,
            ),
...
class NoteService(object):
    ...
    def SaveThread(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/calixa.domain.collaboration.NoteService/SaveThread',
            collaboration__entity__pb2.Thread.SerializeToString,
    ...
    def GetAssociatedThreads(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/calixa.domain.collaboration.NoteService/GetAssociatedThreads',
            collaboration__pb2.GetAssociatedThreadsRequest.SerializeToString,
            collaboration__pb2.GetAssociatedThreadsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def SaveMessage(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/calixa.domain.collaboration.NoteService/SaveMessage',
            collaboration__entity__pb2.Message.SerializeToString,
    ...
    def GetThread(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/calixa.domain.collaboration.NoteService/GetThread',
    ...
    def GetMessages(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/calixa.domain.collaboration.NoteService/GetMessages',
            collaboration__pb2.GetMessageRequest.SerializeToString,
            collaboration__pb2.GetMessageResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
