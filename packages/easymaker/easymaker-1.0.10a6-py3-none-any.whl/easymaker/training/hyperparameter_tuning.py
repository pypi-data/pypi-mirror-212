...
class HyperparameterTuning:
    ...
    def run(self,
            ...
            source_dir_uri=None,
            entry_point=None,
            hyperparameter_spec_list=None,  # [{"name": "","type": "","feasibleSpace": {"min": "","max": "","list": "","step": "",}}, ]
            dataset_list=None,
            ...
            use_log=False,
            wait=True,
            metric_list=None,  # [{"name": ""}, {"name": ""}]
            metric_regex=None,  # ""
            objective_metric=None,  # {"name": ""}
            objective_type=None,  # easymaker.OBJECTIVE_TYPE_CODE.MINIMIZE, MAXIMIZE
            objective_goal=None,  # double
            max_failed_trial_count=None,  # Integer
            max_trial_count=None,  # Integer
            parallel_trial_count=None,  # Integer
