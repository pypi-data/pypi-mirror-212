...
class Ui_DataEditorWindow(object):
    def setupUi(self, DataEditorWindow):
        ...
        self.gridLayout_4.addWidget(self.node_heals_check, 3, 2, 1, 1)
        ...
        self.default_node_check = QCheckBox(self.node_info_group)
        self.default_node_check.setObjectName(u"default_node_check")

        self.gridLayout_4.addWidget(self.default_node_check, 2, 2, 1, 1)
        ...
        self.other_node_alternatives_contents.setGeometry(QRect(0, 0, 229, 145))
    ...
    def retranslateUi(self, DataEditorWindow):
        ...
        self.default_node_check.setText(QCoreApplication.translate("DataEditorWindow", u"Default node", None))
