...
class Ui_NodeDetailsPopup(object):
    def setupUi(self, NodeDetailsPopup):
        ...
        NodeDetailsPopup.resize(556, 698)
        ...
        self.pickup_layout.addWidget(self.location_category_combo, 1, 1, 1, 1)
    ...
    def retranslateUi(self, NodeDetailsPopup):
        ...
        self.node_type_combo.setItemText(5, QCoreApplication.translate("NodeDetailsPopup", u"Configurable", None))
        self.node_type_combo.setItemText(6, QCoreApplication.translate("NodeDetailsPopup", u"Hint", None))
        self.node_type_combo.setItemText(7, QCoreApplication.translate("NodeDetailsPopup", u"Teleporter Network", None))
