    ...
    def fit(self, X, y, varnames=None, alts=None, isvars=None, num_classes=2,
        ...
        if mnl_init and init_class_betas is None:
            ...
            for i in range(num_classes):
                ...
                init_class_betas[i] = mnl.coeff_ + dev.np.random.normal(0, 0.01, len(mnl.coeff_))
        print("Completed MNL coeffs...")
        self.init_class_betas = dev.np.array(init_class_betas)
        self.init_class_thetas = dev.np.array(init_class_thetas)
        print("Completed MNL coeffs (2)...")
