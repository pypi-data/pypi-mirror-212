...
def explicit_finite_difference_solver(Ctt:float, Ctx:float, Cxx:float,
    ...
    """[Deprecated] Solve a partial differential equation with the finite difference method.
    ...
    """
    raise DeprecationWarning("This function is deprecated because of bugs.")
