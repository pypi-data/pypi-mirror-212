...
def plot_amplitudes_spectrum(function, f: float, fs: float,
    ...
    """
    frequencies = spectral_analysis.DFT_frequencies(function, f, fs, args_before_t, args_after_t, function_kwargs)
    amplitudes = spectral_analysis.DFT_amplitudes(function, f, fs, args_before_t, args_after_t, function_kwargs)
...
def plot_phases_spectrum(function, f: float, fs: float, deg: bool = True,
    ...
    """
    frequencies = spectral_analysis.DFT_frequencies(function, f, fs, args_before_t, args_after_t, function_kwargs)
    phases = spectral_analysis.DFT_phases(function, f, fs, deg, args_before_t, args_after_t, function_kwargs)
