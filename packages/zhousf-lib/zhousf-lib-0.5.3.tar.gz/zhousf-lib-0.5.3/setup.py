...
setup(
    ...
    url=URL,
    package_dir={'': 'zhousflib'},
    packages=find_packages(where='zhousflib'),
    install_requires=[i for i in read_file("requirements.txt").strip().splitlines() if i != ''],
    extras_require=EXTRAS,
    data_files=[('zhousflib/font', ['zhousflib/font/simfang.ttf', 'zhousflib/font/SimSun.ttf', 'zhousflib/font/Symbola.ttf'])],
    # install_pakcage_data=True,   recursive-include zhousflib/font *.ttf
    # package_data={},
