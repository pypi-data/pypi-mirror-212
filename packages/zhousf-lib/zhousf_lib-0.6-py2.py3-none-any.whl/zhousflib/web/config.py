...
class CoreConfig(object):
    ...
    ALLOWED_FILE_TYPE = ["jpg", "JPG", "jpeg", "JPEG", "png", "PNG", "bmp", "BMP"]
...
def assign_env(cf, env, log_dir=None):
    ...
    if env_instance.PROJECT_DIR is None:
        ...
        # 在工程的根目录下创建日志目录
        log_root_dir = "{0}/log".format(CoreConfig.PROJECT_DIR)
    # 创建日志目录
