...
def labelme_to_seg(labelme_dir: Path, out_dir: Path, fetch_labels: list = None):
    """
    ...
    if not out_dir.exists():
        out_dir.mkdir()
    save_img_dir = out_dir.joinpath("images")
    save_img_vis_dir = out_dir.joinpath("images_vis")
    save_labels_dir = out_dir.joinpath("labels")
    ...
    out_class_names_file = osp.join(str(out_dir), 'labels.txt')
