...
class ConsoleApi:
    ...
    def login(self, _user='', _pass='', client_id='executor'):
        try:
            ...
            self.trata_error_traceback(traceback.format_exc())
    ...
    def trata_error_traceback(self, error):
        formatted_lines = traceback.format_exc().split('Traceback')[-1]
        error = formatted_lines[0]+': '+formatted_lines[-1]
