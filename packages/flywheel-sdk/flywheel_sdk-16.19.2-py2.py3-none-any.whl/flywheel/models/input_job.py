...
class InputJob(JobMixin):
    ...
    def __init__(self, attempt=1, batch=None, origin=None, compute_provider_id=None, destination=None, gear_id=None, inputs=None, parents=None, label='', previous_job_id=None, tags=None, config=None):  # noqa: E501
