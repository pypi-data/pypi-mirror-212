...
# from frogger.config.shared_configs import *
from frogger.config.shared_configs import BaseTrainingConfig, BaseDatasetConfig, BaseAudioConfig  # others import from here?!
from frogger.utils.generic_utils import find_module
...
def register_config(model_name: str):
    ...
    paths = ["frogger.tts.configs", "frogger.vocoder.configs", "frogger.encoder.configs", "frogger.vc.configs"]
    for path in paths:
        try:
