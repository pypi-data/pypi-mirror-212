...
from frogger.tts.models import setup_model as setup_tts_model

# pylint: disable=unused-wildcard-import
# pylint: disable=wildcard-import
from frogger.tts.utils.synthesis import synthesis, transfer_voice, trim_silence
from frogger.utils.audio import AudioProcessor
from frogger.utils.audio.numpy_transforms import save_wav
from frogger.vc.models import setup_model as setup_vc_model
from frogger.vocoder.models import setup_model as setup_vocoder_model
from frogger.vocoder.utils.generic_utils import interpolate_vocoder_input
...
class Synthesizer(object):
    ...
    def get_inference_stats(self):
        return self.inference_stats or {}
    ...
    def tts(
        ...
        **kwargs,
        ...
        self.inference_stats = {"process": process_time, "audio": audio_time, "rtf": process_time / audio_time}
        return wavs
