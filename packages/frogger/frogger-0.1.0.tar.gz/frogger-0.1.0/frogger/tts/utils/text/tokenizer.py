...
from frogger.tts.utils.text import cleaners
from frogger.tts.utils.text.characters import Graphemes, IPAPhonemes
from frogger.tts.utils.text.phonemizers import DEF_LANG_TO_PHONEMIZER, get_phonemizer_by_name
from frogger.tts.utils.text.phonemizers.multi_phonemizer import MultiPhonemizer
from frogger.utils.generic_utils import get_import_path, import_class
    ...
    def init_from_config(config: "Coqpit", characters: "BaseCharacters" = None):
        ...
        if characters is None:
            ...
            if config.characters and config.characters.characters_class:
                breakpoint()
                print("config.characters.characters_class")
                print(config.characters.characters_class)
