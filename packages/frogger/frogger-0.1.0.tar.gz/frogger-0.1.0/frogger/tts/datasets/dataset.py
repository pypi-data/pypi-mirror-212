...
from frogger.tts.utils.data import prepare_data, prepare_stop_target, prepare_tensor
from frogger.utils.audio import AudioProcessor
from frogger.utils.audio.numpy_transforms import compute_energy as calculate_energy
...
class TTSDataset(Dataset):
    def __init__(
        ...
        Args:
            ...
            ap (frogger.tts.utils.AudioProcessor): Audio processor object.
