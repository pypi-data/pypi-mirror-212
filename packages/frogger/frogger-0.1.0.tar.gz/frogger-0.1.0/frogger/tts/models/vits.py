...
from frogger.tts.configs.shared_configs import CharactersConfig
from frogger.tts.datasets.dataset import TTSDataset, _parse_sample
from frogger.tts.layers.glow_tts.duration_predictor import DurationPredictor
from frogger.tts.layers.vits.discriminator import VitsDiscriminator
from frogger.tts.layers.vits.networks import PosteriorEncoder, ResidualCouplingBlocks, TextEncoder
from frogger.tts.layers.vits.stochastic_duration_predictor import StochasticDurationPredictor
from frogger.tts.models.base_tts import BaseTTS
from frogger.tts.utils.helpers import generate_path, maximum_path, rand_segments, segment, sequence_mask
from frogger.tts.utils.languages import LanguageManager
from frogger.tts.utils.speakers import SpeakerManager
from frogger.tts.utils.synthesis import synthesis
from frogger.tts.utils.text.characters import BaseCharacters, _characters, _pad, _phonemes, _punctuations
from frogger.tts.utils.text.tokenizer import TTSTokenizer
from frogger.utils.io import load_fsspec
from frogger.utils.samplers import BucketBatchSampler
from frogger.vocoder.models.hifigan_generator import HifiganGenerator
from frogger.vocoder.utils.generic_utils import plot_results
...
class Vits(BaseTTS):
    ...
    Check :class:`frogger.tts.configs.vits_config.VitsConfig` for class arguments.

    Examples:
        >>> from frogger.tts.configs.vits_config import VitsConfig
        >>> from frogger.tts.models.vits import Vits
        >>> config = VitsConfig()
        >>> model = Vits(config)
    """
    ...
    def get_criterion(self):
        ...
        `train_step()`"""
        from frogger.tts.layers.losses import (  # pylint: disable=import-outside-toplevel
