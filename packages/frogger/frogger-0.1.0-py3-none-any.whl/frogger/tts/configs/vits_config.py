...
from frogger.tts.configs.shared_configs import BaseTTSConfig
from frogger.tts.models.vits import VitsArgs, VitsAudioConfig
...
class VitsConfig(BaseTTSConfig):
    ...
    Note:
        Check :class:`frogger.tts.configs.shared_configs.BaseTTSConfig` for the inherited parameters.
