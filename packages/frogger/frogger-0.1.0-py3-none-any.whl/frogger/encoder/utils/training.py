...
from frogger.config import load_config, register_config
from frogger.tts.utils.text.characters import parse_symbols
from frogger.utils.generic_utils import get_experiment_folder_path, get_git_branch
...
def process_args(args, config=None):
    ...
    if config is None:
        if args.config_path:
            ...
            from frogger.config.shared_configs import BaseTrainingConfig  # pylint: disable=import-outside-toplevel
