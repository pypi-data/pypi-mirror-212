...
from dcim.api.serializers import NestedDeviceTypeSerializer
...
class CiscoSupportSerializer(NetBoxModelSerializer):
    ...
    # device_type_support = NestedCiscoDeviceTypeSupportSerializer()
    ...
    class Meta:
        ...
        fields = (
            ...
            "warranty_type", "device_type", "recommended_release", "desired_release",
