...
setup(
    ...
    version=version,
    python_requires=">=3.7",
    description="A fake typosquat malicious library of checkov, used only for testing purposes. The library supposedly steals the user's env vars and sends it to a remote server, the domain is fake though so no data is actually stolen.",
    author="bridgecrew",
