...
class Status:
    ...
    def module(self):
        ...
        print("gitlab_token in the main ",gitlab_token)

        mylist = []
        path_absolute = os.getcwd()
        path_absolute = "/home/alisaidani1/facturation/infra/infra"
        # print("paaaath _ absoluuute" , path_absolute)
        ...
        for row in range(1, len(dictionary)+2):
