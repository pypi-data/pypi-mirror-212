...
from ..models.deno_to_jsonschema_response_200_args_item_typ_type_3 import DenoToJsonschemaResponse200ArgsItemTypType3
from ..models.deno_to_jsonschema_response_200_args_item_typ_type_4 import DenoToJsonschemaResponse200ArgsItemTypType4
...
class DenoToJsonschemaResponse200ArgsItem:
    ...
    Attributes:
        ...
        typ (Union[DenoToJsonschemaResponse200ArgsItemTypType0, DenoToJsonschemaResponse200ArgsItemTypType1,
            DenoToJsonschemaResponse200ArgsItemTypType2, DenoToJsonschemaResponse200ArgsItemTypType3,
            DenoToJsonschemaResponse200ArgsItemTypType4]):
    ...
    typ: Union[
        ...
        DenoToJsonschemaResponse200ArgsItemTypType3,
        DenoToJsonschemaResponse200ArgsItemTypType4,
    ]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.typ, DenoToJsonschemaResponse200ArgsItemTypType2):
            typ = self.typ.to_dict()

        elif isinstance(self.typ, DenoToJsonschemaResponse200ArgsItemTypType3):
            typ = self.typ.to_dict()
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_typ(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                typ_type_3 = DenoToJsonschemaResponse200ArgsItemTypType3.from_dict(data)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            typ_type_4 = DenoToJsonschemaResponse200ArgsItemTypType4.from_dict(data)
