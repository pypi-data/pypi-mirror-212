...
def _get_kwargs(
    *,
    ...
    url = "{}/Users/Query".format(client.base_url)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[Any, QueryResultUserDto]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = QueryResultUserDto.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[Any, QueryResultUserDto]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    limit: Union[Unset, None, int] = UNSET,
    name_starts_with_or_greater: Union[Unset, None, str] = UNSET,
) -> Response[Union[Any, QueryResultUserDto]]:
...
def sync(
    *,
    ...
    limit: Union[Unset, None, int] = UNSET,
    name_starts_with_or_greater: Union[Unset, None, str] = UNSET,
) -> Optional[Union[Any, QueryResultUserDto]]:
    """Gets a list of users
