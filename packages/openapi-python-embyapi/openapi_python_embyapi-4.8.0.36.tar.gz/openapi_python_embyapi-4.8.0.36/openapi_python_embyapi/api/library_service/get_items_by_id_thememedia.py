...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/Items/{Id}/ThemeMedia".format(client.base_url, Id=id)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[AllThemeMediaResult, Any]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[AllThemeMediaResult, Any]]:
    return Response(
