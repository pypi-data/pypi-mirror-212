...
T = TypeVar("T", bound="ProvidersRemoteSearchQueryProvidersAlbumInfo")


@attr.s(auto_attribs=True)
class ProvidersRemoteSearchQueryProvidersAlbumInfo:
    """
    Attributes:
        search_info (Union[Unset, ProvidersAlbumInfo]):
    ...
    search_info: Union[Unset, "ProvidersAlbumInfo"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_search_info, Unset):
            ...
            search_info = ProvidersAlbumInfo.from_dict(_search_info)
        ...
        providers_remote_search_query_providers_album_info = cls(
        ...
        providers_remote_search_query_providers_album_info.additional_properties = d
        return providers_remote_search_query_providers_album_info
