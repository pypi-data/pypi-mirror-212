...
T = TypeVar("T", bound="ProvidersSeriesInfo")


@attr.s(auto_attribs=True)
class ProvidersSeriesInfo:
    """
    Attributes:
        episode_air_date (Union[Unset, None, datetime.datetime]):
        display_order (Union[Unset, SeriesDisplayOrder]):
    ...
    episode_air_date: Union[Unset, None, datetime.datetime] = UNSET
    display_order: Union[Unset, SeriesDisplayOrder] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        episode_air_date: Union[Unset, None, str] = UNSET
        if not isinstance(self.episode_air_date, Unset):
            episode_air_date = self.episode_air_date.isoformat() if self.episode_air_date else None

        display_order: Union[Unset, str] = UNSET
        if not isinstance(self.display_order, Unset):
        ...
        field_dict.update({})
        if episode_air_date is not UNSET:
            field_dict["EpisodeAirDate"] = episode_air_date
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        _episode_air_date = d.pop("EpisodeAirDate", UNSET)
        episode_air_date: Union[Unset, None, datetime.datetime]
        if _episode_air_date is None:
            episode_air_date = None
        elif isinstance(_episode_air_date, Unset):
            episode_air_date = UNSET
        else:
            episode_air_date = isoparse(_episode_air_date)

        _display_order = d.pop("DisplayOrder", UNSET)
        display_order: Union[Unset, SeriesDisplayOrder]
        if isinstance(_display_order, Unset):
            display_order = UNSET
        else:
            display_order = SeriesDisplayOrder(_display_order)
        ...
        providers_series_info.additional_properties = d
        return providers_series_info
