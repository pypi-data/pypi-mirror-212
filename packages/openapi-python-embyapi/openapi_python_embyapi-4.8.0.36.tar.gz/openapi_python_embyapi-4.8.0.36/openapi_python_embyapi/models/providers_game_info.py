...
T = TypeVar("T", bound="ProvidersGameInfo")


@attr.s(auto_attribs=True)
class ProvidersGameInfo:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        providers_game_info.additional_properties = d
        return providers_game_info
