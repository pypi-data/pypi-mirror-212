...
T = TypeVar("T", bound="ProvidersRemoteSearchQueryProvidersPersonLookupInfo")


@attr.s(auto_attribs=True)
class ProvidersRemoteSearchQueryProvidersPersonLookupInfo:
    """
    Attributes:
        search_info (Union[Unset, ProvidersPersonLookupInfo]):
    ...
    search_info: Union[Unset, "ProvidersPersonLookupInfo"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_search_info, Unset):
            ...
            search_info = ProvidersPersonLookupInfo.from_dict(_search_info)
        ...
        providers_remote_search_query_providers_person_lookup_info = cls(
        ...
        providers_remote_search_query_providers_person_lookup_info.additional_properties = d
        return providers_remote_search_query_providers_person_lookup_info
