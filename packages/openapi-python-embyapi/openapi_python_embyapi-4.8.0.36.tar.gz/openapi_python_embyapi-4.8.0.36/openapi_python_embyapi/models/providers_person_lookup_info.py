...
T = TypeVar("T", bound="ProvidersPersonLookupInfo")


@attr.s(auto_attribs=True)
class ProvidersPersonLookupInfo:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        providers_person_lookup_info = cls(
            name=name,
        ...
        providers_person_lookup_info.additional_properties = d
        return providers_person_lookup_info
