...
T = TypeVar("T", bound="QueryResultActivityLogEntry")


@attr.s(auto_attribs=True)
class QueryResultActivityLogEntry:
    """
    Attributes:
        items (Union[Unset, List['ActivityLogEntry']]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        query_result_activity_log_entry = cls(
            items=items,
            total_record_count=total_record_count,
        )

        query_result_activity_log_entry.additional_properties = d
        return query_result_activity_log_entry
