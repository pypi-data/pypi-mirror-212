...
T = TypeVar("T", bound="ProvidersRemoteSearchQueryProvidersArtistInfo")


@attr.s(auto_attribs=True)
class ProvidersRemoteSearchQueryProvidersArtistInfo:
    """
    Attributes:
        search_info (Union[Unset, ProvidersArtistInfo]):
    ...
    search_info: Union[Unset, "ProvidersArtistInfo"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_search_info, Unset):
            ...
            search_info = ProvidersArtistInfo.from_dict(_search_info)
        ...
        providers_remote_search_query_providers_artist_info = cls(
        ...
        providers_remote_search_query_providers_artist_info.additional_properties = d
        return providers_remote_search_query_providers_artist_info
