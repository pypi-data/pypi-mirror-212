...
T = TypeVar("T", bound="ProvidersRemoteSearchQueryProvidersBookInfo")


@attr.s(auto_attribs=True)
class ProvidersRemoteSearchQueryProvidersBookInfo:
    """
    Attributes:
        search_info (Union[Unset, ProvidersBookInfo]):
    ...
    search_info: Union[Unset, "ProvidersBookInfo"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_search_info, Unset):
            ...
            search_info = ProvidersBookInfo.from_dict(_search_info)
        ...
        providers_remote_search_query_providers_book_info = cls(
        ...
        providers_remote_search_query_providers_book_info.additional_properties = d
        return providers_remote_search_query_providers_book_info
