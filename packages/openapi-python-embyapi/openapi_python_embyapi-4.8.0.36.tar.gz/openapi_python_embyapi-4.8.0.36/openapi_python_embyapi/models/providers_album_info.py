...
T = TypeVar("T", bound="ProvidersAlbumInfo")


@attr.s(auto_attribs=True)
class ProvidersAlbumInfo:
    """
    Attributes:
        album_artists (Union[Unset, List[str]]):
        song_infos (Union[Unset, List['ProvidersSongInfo']]):
    ...
    song_infos: Union[Unset, List["ProvidersSongInfo"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for song_infos_item_data in _song_infos or []:
            song_infos_item = ProvidersSongInfo.from_dict(song_infos_item_data)
        ...
        providers_album_info.additional_properties = d
        return providers_album_info
