...
T = TypeVar("T", bound="ProvidersRemoteSearchQueryProvidersMusicVideoInfo")


@attr.s(auto_attribs=True)
class ProvidersRemoteSearchQueryProvidersMusicVideoInfo:
    """
    Attributes:
        search_info (Union[Unset, ProvidersMusicVideoInfo]):
    ...
    search_info: Union[Unset, "ProvidersMusicVideoInfo"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_search_info, Unset):
            ...
            search_info = ProvidersMusicVideoInfo.from_dict(_search_info)
        ...
        providers_remote_search_query_providers_music_video_info = cls(
        ...
        providers_remote_search_query_providers_music_video_info.additional_properties = d
        return providers_remote_search_query_providers_music_video_info
