...
T = TypeVar("T", bound="ProvidersMovieInfo")


@attr.s(auto_attribs=True)
class ProvidersMovieInfo:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        providers_movie_info.additional_properties = d
        return providers_movie_info
