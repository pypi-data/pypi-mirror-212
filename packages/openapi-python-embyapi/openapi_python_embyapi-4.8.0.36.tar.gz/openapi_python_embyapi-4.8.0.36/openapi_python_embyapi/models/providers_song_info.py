...
T = TypeVar("T", bound="ProvidersSongInfo")


@attr.s(auto_attribs=True)
class ProvidersSongInfo:
    """
    Attributes:
        album_artists (Union[Unset, List[str]]):
        album (Union[Unset, str]):
        artists (Union[Unset, List[str]]):
        composers (Union[Unset, List[str]]):
    ...
    composers: Union[Unset, List[str]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        composers = cast(List[str], d.pop("Composers", UNSET))
        ...
        providers_song_info.additional_properties = d
        return providers_song_info
