...
T = TypeVar("T", bound="ProvidersItemLookupInfo")


@attr.s(auto_attribs=True)
class ProvidersItemLookupInfo:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        providers_item_lookup_info = cls(
            name=name,
        ...
        providers_item_lookup_info.additional_properties = d
        return providers_item_lookup_info
