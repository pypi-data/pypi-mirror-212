...
T = TypeVar("T", bound="ProvidersMusicVideoInfo")


@attr.s(auto_attribs=True)
class ProvidersMusicVideoInfo:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        providers_music_video_info = cls(
            artists=artists,
            name=name,
        ...
        providers_music_video_info.additional_properties = d
        return providers_music_video_info
