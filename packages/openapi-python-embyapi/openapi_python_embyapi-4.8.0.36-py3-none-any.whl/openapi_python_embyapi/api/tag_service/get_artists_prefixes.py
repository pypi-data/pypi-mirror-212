...
def _get_kwargs(
    *,
    ...
    url = "{}/Artists/Prefixes".format(client.base_url)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[Any, List["NameValuePair"]]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = NameValuePair.from_dict(response_200_item_data)
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[Any, List["NameValuePair"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    name_starts_with: Union[Unset, None, str] = UNSET,
    name_less_than: Union[Unset, None, str] = UNSET,
) -> Response[Union[Any, List["NameValuePair"]]]:
...
def sync(
    *,
    ...
    name_starts_with: Union[Unset, None, str] = UNSET,
    name_less_than: Union[Unset, None, str] = UNSET,
) -> Optional[Union[Any, List["NameValuePair"]]]:
    """Gets items based on a query.
