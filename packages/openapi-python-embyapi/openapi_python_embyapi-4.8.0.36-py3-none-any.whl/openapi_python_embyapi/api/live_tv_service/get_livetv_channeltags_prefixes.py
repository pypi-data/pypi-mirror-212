...
def _get_kwargs(
    *,
    ...
    url = "{}/LiveTv/ChannelTags/Prefixes".format(client.base_url)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[Any, List["LiveTVApiTagItem"]]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = LiveTVApiTagItem.from_dict(response_200_item_data)
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[Any, List["LiveTVApiTagItem"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    name_starts_with: Union[Unset, None, str] = UNSET,
    name_less_than: Union[Unset, None, str] = UNSET,
) -> Response[Union[Any, List["LiveTVApiTagItem"]]]:
...
def sync(
    *,
    ...
    name_starts_with: Union[Unset, None, str] = UNSET,
    name_less_than: Union[Unset, None, str] = UNSET,
) -> Optional[Union[Any, List["LiveTVApiTagItem"]]]:
    """Gets live tv channel tag prefixes
    ...
    Returns:
        Union[Any, List['LiveTVApiTagItem']]
    """
