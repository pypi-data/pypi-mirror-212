...
def _get_kwargs(
    *,
    ...
    url = "{}/LiveTv/ListingProviders/Lineups".format(client.base_url)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[Any, List["NameIdPair"]]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[Any, List["NameIdPair"]]]:
    return Response(
