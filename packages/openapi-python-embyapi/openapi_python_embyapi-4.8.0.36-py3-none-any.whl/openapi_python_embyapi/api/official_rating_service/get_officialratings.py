...
def _get_kwargs(
    *,
    ...
    url = "{}/OfficialRatings".format(client.base_url)
...
) -> Optional[Union[Any, QueryResultUserLibraryOfficialRatingItem]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = QueryResultUserLibraryOfficialRatingItem.from_dict(response.json())
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[Any, QueryResultUserLibraryOfficialRatingItem]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, QueryResultUserLibraryOfficialRatingItem]
    """
