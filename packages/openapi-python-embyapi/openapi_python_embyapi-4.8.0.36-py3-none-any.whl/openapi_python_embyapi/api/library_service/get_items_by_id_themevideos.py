...
def _get_kwargs(
    ...
    *,
    ...
    inherit_from_parent: Union[Unset, None, bool] = UNSET,
    ...
    url = "{}/Items/{Id}/ThemeVideos".format(client.base_url, Id=id)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[Any, ThemeMediaResult]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[Any, ThemeMediaResult]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    enable_user_data: Union[Unset, None, bool] = UNSET,
    fields: Union[Unset, None, str] = UNSET,
) -> Response[Union[Any, ThemeMediaResult]]:
...
def sync(
    ...
    *,
    ...
    enable_user_data: Union[Unset, None, bool] = UNSET,
    fields: Union[Unset, None, str] = UNSET,
) -> Optional[Union[Any, ThemeMediaResult]]:
    """Gets theme videos for an item
