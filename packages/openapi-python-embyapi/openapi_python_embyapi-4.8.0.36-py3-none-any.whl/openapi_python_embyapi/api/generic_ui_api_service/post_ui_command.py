...
from ...models.emby_web_generic_ui_api_endpoints_run_ui_command import EmbyWebGenericUIApiEndpointsRunUICommand
...
def _get_kwargs(
    *,
    ...
    json_body: EmbyWebGenericUIApiEndpointsRunUICommand,
) -> Dict[str, Any]:
    url = "{}/UI/Command".format(client.base_url)
