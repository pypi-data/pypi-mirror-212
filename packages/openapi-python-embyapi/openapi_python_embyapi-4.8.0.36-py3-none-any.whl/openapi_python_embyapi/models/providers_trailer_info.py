...
T = TypeVar("T", bound="ProvidersTrailerInfo")


@attr.s(auto_attribs=True)
class ProvidersTrailerInfo:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        providers_trailer_info.additional_properties = d
        return providers_trailer_info
