...
T = TypeVar("T", bound="LibraryPostUpdatedMedia")


@attr.s(auto_attribs=True)
class LibraryPostUpdatedMedia:
    """
    Attributes:
        updates (Union[Unset, List['LibraryMediaUpdateInfo']]):
    """

    updates: Union[Unset, List["LibraryMediaUpdateInfo"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for updates_item_data in _updates or []:
            updates_item = LibraryMediaUpdateInfo.from_dict(updates_item_data)

            updates.append(updates_item)

        library_post_updated_media = cls(
            updates=updates,
        )

        library_post_updated_media.additional_properties = d
        return library_post_updated_media
