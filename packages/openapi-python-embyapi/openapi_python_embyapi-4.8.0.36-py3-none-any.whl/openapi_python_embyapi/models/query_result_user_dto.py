...
T = TypeVar("T", bound="QueryResultUserDto")
...
class QueryResultUserDto:
    """
    Attributes:
        items (Union[Unset, List['UserDto']]):
        total_record_count (Union[Unset, int]):
    """

    items: Union[Unset, List["UserDto"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        query_result_user_dto = cls(
            items=items,
            total_record_count=total_record_count,
        )

        query_result_user_dto.additional_properties = d
        return query_result_user_dto
