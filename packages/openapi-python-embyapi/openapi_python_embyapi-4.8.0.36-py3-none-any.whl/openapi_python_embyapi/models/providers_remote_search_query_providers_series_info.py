...
T = TypeVar("T", bound="ProvidersRemoteSearchQueryProvidersSeriesInfo")


@attr.s(auto_attribs=True)
class ProvidersRemoteSearchQueryProvidersSeriesInfo:
    """
    Attributes:
        search_info (Union[Unset, ProvidersSeriesInfo]):
    ...
    search_info: Union[Unset, "ProvidersSeriesInfo"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_search_info, Unset):
            ...
            search_info = ProvidersSeriesInfo.from_dict(_search_info)
        ...
        providers_remote_search_query_providers_series_info = cls(
        ...
        providers_remote_search_query_providers_series_info.additional_properties = d
        return providers_remote_search_query_providers_series_info
