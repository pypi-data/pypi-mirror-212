...
T = TypeVar("T", bound="ProvidersRemoteSearchQueryProvidersItemLookupInfo")


@attr.s(auto_attribs=True)
class ProvidersRemoteSearchQueryProvidersItemLookupInfo:
    """
    Attributes:
        search_info (Union[Unset, ProvidersItemLookupInfo]):
    ...
    search_info: Union[Unset, "ProvidersItemLookupInfo"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_search_info, Unset):
            ...
            search_info = ProvidersItemLookupInfo.from_dict(_search_info)
        ...
        providers_remote_search_query_providers_item_lookup_info = cls(
        ...
        providers_remote_search_query_providers_item_lookup_info.additional_properties = d
        return providers_remote_search_query_providers_item_lookup_info
