...
T = TypeVar("T", bound="EmbyWebGenericEditEditorsEditorButtonItem")


@attr.s(auto_attribs=True)
class EmbyWebGenericEditEditorsEditorButtonItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        emby_web_generic_edit_editors_editor_button_item = cls(
        ...
        emby_web_generic_edit_editors_editor_button_item.additional_properties = d
        return emby_web_generic_edit_editors_editor_button_item
