...
T = TypeVar("T", bound="QueryResultBaseItemDto")


@attr.s(auto_attribs=True)
class QueryResultBaseItemDto:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        query_result_base_item_dto = cls(
            items=items,
            total_record_count=total_record_count,
        )

        query_result_base_item_dto.additional_properties = d
        return query_result_base_item_dto
