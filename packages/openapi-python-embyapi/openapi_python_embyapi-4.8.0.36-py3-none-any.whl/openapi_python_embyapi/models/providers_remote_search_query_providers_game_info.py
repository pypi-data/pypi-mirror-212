...
T = TypeVar("T", bound="ProvidersRemoteSearchQueryProvidersGameInfo")


@attr.s(auto_attribs=True)
class ProvidersRemoteSearchQueryProvidersGameInfo:
    """
    Attributes:
        search_info (Union[Unset, ProvidersGameInfo]):
    ...
    search_info: Union[Unset, "ProvidersGameInfo"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_search_info, Unset):
            ...
            search_info = ProvidersGameInfo.from_dict(_search_info)
        ...
        providers_remote_search_query_providers_game_info = cls(
        ...
        providers_remote_search_query_providers_game_info.additional_properties = d
        return providers_remote_search_query_providers_game_info
