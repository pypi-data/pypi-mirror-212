...
T = TypeVar("T", bound="DlnaTranscodingProfile")


@attr.s(auto_attribs=True)
class DlnaTranscodingProfile:
    """
    Attributes:
        ...
        transcode_seek_info (Union[Unset, DlnaTranscodeSeekInfo]):
        copy_timestamps (Union[Unset, bool]):
        context (Union[Unset, DlnaEncodingContext]):
        max_audio_channels (Union[Unset, str]):
        ...
        manifest_subtitles (Union[Unset, str]):
        max_manifest_subtitles (Union[Unset, int]):
    """
    ...
    estimate_content_length: Union[Unset, bool] = UNSET
    enable_mpegts_m2_ts_mode: Union[Unset, bool] = UNSET
    transcode_seek_info: Union[Unset, DlnaTranscodeSeekInfo] = UNSET
    copy_timestamps: Union[Unset, bool] = UNSET
    context: Union[Unset, DlnaEncodingContext] = UNSET
    max_audio_channels: Union[Unset, str] = UNSET
    ...
    manifest_subtitles: Union[Unset, str] = UNSET
    max_manifest_subtitles: Union[Unset, int] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        manifest_subtitles = self.manifest_subtitles
        max_manifest_subtitles = self.max_manifest_subtitles
        ...
        if manifest_subtitles is not UNSET:
            field_dict["ManifestSubtitles"] = manifest_subtitles
        if max_manifest_subtitles is not UNSET:
            field_dict["MaxManifestSubtitles"] = max_manifest_subtitles
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_transcode_seek_info, Unset):
            ...
            transcode_seek_info = DlnaTranscodeSeekInfo(_transcode_seek_info)
        ...
        if isinstance(_context, Unset):
            ...
            context = DlnaEncodingContext(_context)
        ...
        manifest_subtitles = d.pop("ManifestSubtitles", UNSET)

        max_manifest_subtitles = d.pop("MaxManifestSubtitles", UNSET)

        dlna_transcoding_profile = cls(
            container=container,
            type=type,
            ...
            manifest_subtitles=manifest_subtitles,
            max_manifest_subtitles=max_manifest_subtitles,
        )

        dlna_transcoding_profile.additional_properties = d
        return dlna_transcoding_profile
