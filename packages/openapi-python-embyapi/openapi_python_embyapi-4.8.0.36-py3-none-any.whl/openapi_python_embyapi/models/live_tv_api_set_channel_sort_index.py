...
T = TypeVar("T", bound="LiveTVApiSetChannelSortIndex")


@attr.s(auto_attribs=True)
class LiveTVApiSetChannelSortIndex:
    """
    Attributes:
        id (Union[Unset, str]):
        management_id (Union[Unset, str]):
        new_index (Union[Unset, int]):
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        live_tv_api_set_channel_sort_index = cls(
            id=id,
            management_id=management_id,
            new_index=new_index,
        )

        live_tv_api_set_channel_sort_index.additional_properties = d
        return live_tv_api_set_channel_sort_index
