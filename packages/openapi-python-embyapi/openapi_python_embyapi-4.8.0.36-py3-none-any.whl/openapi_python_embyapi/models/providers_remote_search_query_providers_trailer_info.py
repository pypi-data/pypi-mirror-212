...
T = TypeVar("T", bound="ProvidersRemoteSearchQueryProvidersTrailerInfo")


@attr.s(auto_attribs=True)
class ProvidersRemoteSearchQueryProvidersTrailerInfo:
    """
    Attributes:
        search_info (Union[Unset, ProvidersTrailerInfo]):
    ...
    search_info: Union[Unset, "ProvidersTrailerInfo"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_search_info, Unset):
            ...
            search_info = ProvidersTrailerInfo.from_dict(_search_info)
        ...
        providers_remote_search_query_providers_trailer_info = cls(
        ...
        providers_remote_search_query_providers_trailer_info.additional_properties = d
        return providers_remote_search_query_providers_trailer_info
