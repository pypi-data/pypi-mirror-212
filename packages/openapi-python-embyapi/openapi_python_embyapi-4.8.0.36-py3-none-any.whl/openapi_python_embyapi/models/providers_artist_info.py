...
T = TypeVar("T", bound="ProvidersArtistInfo")


@attr.s(auto_attribs=True)
class ProvidersArtistInfo:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        providers_artist_info.additional_properties = d
        return providers_artist_info
