...
def get_wy(dates, wy_month=7, using_end_year=False):
    ...
    follows the convention used for fiscal years whereby water years are labelled based on their end dates. E.g. the 2022 water 
    ...
    corresponding to the water year.
    """
    if using_end_year:
