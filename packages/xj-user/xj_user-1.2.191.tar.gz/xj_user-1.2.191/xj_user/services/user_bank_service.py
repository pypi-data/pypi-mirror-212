...
class UserBankCardsService():
    ...
    def list(params=None):
        ...
        filter_params = format_params_handle(
            param_dict=params,
            filter_filed_list=["id", "user_id", "bank_card_num", "open_account_bank", "is_default", ]
        )
        # 排序字段
        allow_sort = ["id", "-id", "sort", "-sort"]
        sort = sort if sort in allow_sort else "-id"
        cards_obj = UserBankCards.objects.filter(**filter_params).order_by(sort).values()
    ...
    def add(params=None):
        ...
        filter_params = format_params_handle(
            param_dict=params,
            filter_filed_list=["user_id|int", "bank_card_num", "open_account_bank", "is_default|int", "remark", "ext|dict"]
        )
        try:
    ...
    def edit(pk=None, update_params=None):
        ...
        filter_params = format_params_handle(
            ...
            filter_filed_list=["bank_card_num", "open_account_bank", "is_default|int", "remark", "ext|dict"]
        )
