...
class DatasetsApi(object):
    ...
    def datasets_id_dimensionality_reduction_put(
        ...
        **kwargs
        ...
        Reduce the dimensionality of a dataset down to a specified number of dimensions through PCA or UMAP. The dataset being reduced must have at least 5 rows and at most 50,000 rows. There must also be fewer than 10,000 columns and fewer than 5,000,000 cells overall. Vector columns and Categorical columns are not supported and will be ignored during reduction.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
