...
"""! @brief DS_SharedArtifacts base class for the SharedArtifacts class."""
...
class DS_SharedArtifacts():
    """! DS_SharedArtifacts is the base class for the SharedArtifacts class."""

    def __init__(self) -> None:
        """! DS_SharedArtifacts initializer.
