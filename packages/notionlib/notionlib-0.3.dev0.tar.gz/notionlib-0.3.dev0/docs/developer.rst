...
.. warning::
   ...
   `notionlib` package. If you just want to write code that uses it
...
In your terminal, change to the directory where you cloned `notionlib`, and type::

    conda env create -f environment.yml

This will create a conda virtual environment called `notionlib-dev` with all
the Python Client for Notion.so dependencies and a few useful packages for development and
interaction.
...
* On Windows, in your Anaconda Prompt, run ``activate notionlib-dev``
* On MacOSX and Linux, in your Terminal, run ``source activate notionlib-dev``
...
type::
    ...
    conda list -n notionlib-dev

If later you want to leave the `notionlib-dev` virtual environment:
...
then on, all the Python Client for Notion.so binaries and the library itself will be
...
.. _available on GitHub: https://github.com/jdhp/notion-lib
...
.. _TODO.md: https://github.com/jdhp/notion-lib/blob/master/TODO.md
