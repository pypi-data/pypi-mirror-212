        ...
        try:
            ...
            if agent is not None:
                ...
                if o is not None:
                    ...
                    pi = o.profiler.start_query(REMOTE_CALL_TYPE_MONGODB, self.collection + ".insert_many(" + parameter + ")",
                                                self.host, self.port)
        except:
            pass
        ...
        try:
            ...
            if agent is not None:
                ...
                if o is not None:
                    ...
                    pi = o.profiler.start_query(REMOTE_CALL_TYPE_MONGODB, self.collection + ".update_many(" + parameter + ")",
                                                self.host, self.port)
        except:
            pass
        ...
        try:
            ...
            if agent is not None:
                ...
                if o is not None:
                    ...
                    pi = o.profiler.start_query(REMOTE_CALL_TYPE_MONGODB, self.collection + ".update_one(" + parameter + ")",
                                                self.host, self.port)
        except:
            pass
