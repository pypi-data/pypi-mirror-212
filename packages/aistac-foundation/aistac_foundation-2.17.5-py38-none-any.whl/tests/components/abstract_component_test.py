...
class AbstractComponentTest(unittest.TestCase):
    ...
    def test_default_connector(self):
        ...
        # set source
        manager.add_connector_from_template(connector_name='source', uri_file='mysource.pickle', template_name=manager.pm.TEMPLATE_SOURCE)
        ...
        self.assertEqual('PythonSourceHandler', connector.handler)
        # set persist
        manager.add_connector_from_template(connector_name='persist', uri_file='mypersist.pickle', template_name=manager.pm.TEMPLATE_PERSIST)
