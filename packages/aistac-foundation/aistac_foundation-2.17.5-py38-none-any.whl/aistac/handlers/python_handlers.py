...
class PythonSourceHandler(AbstractSourceHandler):
    ...
    def _csv_load(self, path_file: str, **kwargs) -> dict:
        """ loads a csv file """
    ...
    def _pickle_load(self, path_file: str, **kwargs) -> dict:
        """ loads a pickle file """
    ...
    def _json_load(self, path_file: str, **kwargs) -> dict:
        """ loads a pickle file """
        with self._lock:
...
class PythonPersistHandler(PythonSourceHandler, AbstractPersistHandler):
    ...
    def _csv_dump(self, canonical: dict, path_file: str, **kwargs) -> None:
        """ loads a csv file """
        encoding = kwargs.pop('encoding', 'utf-8')
        with self._lock:
    ...
    def _pickle_dump(self, data: dict, path_file: str, **kwargs) -> None:
        """ dumps a pickle file"""
