...
one trajectory frame per file."""
    ...
    @abc.abstractmethod
    def parse(self, data: ovito.data.DataCollection, *, filename: str, url: str, byte_offset: int, line_number: int, parser_data: Any, is_newfile: bool, **kwargs: Any) -> Optional[Generator[Union[str, float], None, None]]:
