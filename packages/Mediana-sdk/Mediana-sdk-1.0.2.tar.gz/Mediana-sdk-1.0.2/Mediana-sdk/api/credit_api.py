...
class CreditApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_credit_endpoint = _Endpoint(
            settings={
                'response_type': (InlineResponse2001,),
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/v1/credit',
                'operation_id': 'get_credit',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_credit(
        ...
        **kwargs
        ...
        get user credit  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_credit(async_req=True)
        >>> result = thread.get()
        ...
        return self.get_credit_endpoint.call_with_http_info(**kwargs)
