...
from .jobs.send_code import SendSlackEmailJob, SendSlackEmailJobData
from .jobs.workspace_connect import ConnectSlackAccountJob, ConnectSlackAccountJobData
...
jobs_map = {
    ...
    "SendCodeJob": SendSlackEmailJob,
    "ConnectSlackAccountJob": ConnectSlackAccountJob,
