...
const hooks_1 = __webpack_require__(/*! ../hooks */ "./lib/hooks.js");
const icons_react_1 = __webpack_require__(/*! @tabler/icons-react */ "webpack/sharing/consume/default/@tabler/icons-react/@tabler/icons-react");
const NumericElement = ({ item, color, activated }) => {
    const textColor = color > 125 ? 0 : 255;
    return (react_2.default.createElement(core_1.Box, { bg: activated ? `rgb(${color}, ${color}, ${color})` : "transparent", c: activated ? `rgb(${textColor}, ${textColor}, ${textColor})` : "black" },
...
const DataTable = ({ page, setPage, rowNumber, setRowNumber }) => {
    ...
    const [color, setColor] = react_1.useState((_c = model === null || model === void 0 ? void 0 : model.get("column_color")) !== null && _c !== void 0 ? _c : "");
    model === null || model === void 0 ? void 0 : model.on("change:column_color", () => setColor(model.get("column_color")));
    const [tempoIndex, setTempoIndex] = react_1.useState(1);
    const [outOfRange, setOutOfRange] = react_1.useState(false);
    const [activatedFormatting, setActiedFormatting] = react_1.useState(false);
    ...
    const rows = info.index.map((index) => (react_2.default.createElement("tr", { key: base_1.uuid() },
        ...
        info.data[index].map((item, tdIndex) => (react_2.default.createElement("td", { key: tdIndex, style: { fontSize: "8px" } }, typeof (item) === "boolean" ?
            ...
            :
                typeof (item) === "string" ?
                    ...
                    :
                        react_2.default.createElement(NumericElement, { item: item, color: colorMatrix[index] ? colorMatrix[index][tdIndex] : 255, activated: activatedFormatting })))))));
        ...
        react_2.default.createElement(core_1.Group, { position: "apart", sx: { width: "100%" } },
            ...
            react_2.default.createElement(core_1.Group, { align: "center" },
                react_2.default.createElement(core_1.Tooltip, { label: "Conditional Formatting", withArrow: true },
                    react_2.default.createElement(core_1.ActionIcon, { variant: "transparent", onClick: () => { setActiedFormatting(!activatedFormatting); } },
...
//# sourceMappingURL=lib_WidgetModel_js.82d7547d6195bc466599.js.map