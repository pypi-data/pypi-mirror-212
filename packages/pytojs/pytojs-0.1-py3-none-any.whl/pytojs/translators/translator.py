...
# Enable pytojs exceptions and pyimport in parser
...
# import pytojs.pyjs, sys
# # Redefine builtin objects... Do you have a better idea?
# for m in list(sys.modules):
# 	if m.startswith('pytojs'):
# 		del sys.modules[m]
# del pytojs.pyjs
# del pytojs

DEFAULT_HEADER = u'''from pytojs.pyjs import *
# setting scope
