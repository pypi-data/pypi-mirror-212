'''Most important file in pytojs implementation: PyJs class - father of all PyJs objects'''
...
import pyjsparser
pyjsparser.parser.ENABLE_pytojs_ERRORS = lambda msg: MakeError('SyntaxError', msg)
