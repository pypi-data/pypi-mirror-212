...
class UpdateSpendPowerCustomizationRequest(
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["timeframe"]) -> typing.Union['SpendPowerTimeFrame', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        timeframe: typing.Union['SpendPowerTimeFrame', schemas.Unset] = schemas.unset,
    ...
    ) -> 'UpdateSpendPowerCustomizationRequest':
