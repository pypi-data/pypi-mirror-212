...
SchemaFor200ResponseBodyApplicationJson = GetSpendPowerCustomizationResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_spend_power_customization_oapg(
        self,
...
class GetSpendPowerCustomization(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_spend_power_customization(
        self,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_spend_power_customization(
        ...
        return self._get_spend_power_customization_oapg(
