...
def _walrus_wrapper_lambda_c92be7e6ad804db3a6ad95001338e284( NAME, DOCS, FLAG, ENUM, MODL):
    """Wrapper function for lambda definitions."""
    if False:
        name = NotImplemented

    def _walrus_wrapper_name_cbe149a2fb2a4e0fa6afa4740e5eb14d(expr):
...
"""{(_walrus_wrapper_name_cbe149a2fb2a4e0fa6afa4740e5eb14d(DOCS.split(' [', maxsplit=1)[0]))}
{'=' * (len(name) + 6)}
...
class {NAME}(IntFlag):
    ...
    def _missing_(cls, value: 'int') -> '{NAME}':
        ...
        return cls(value)
'''
LINE =_walrus_wrapper_lambda_c92be7e6ad804db3a6ad95001338e284  # type: Callable[[str, str, str, str, str], str]
