...
def _walrus_wrapper_lambda_4eac8db5acac499a9c002b6f9d37f8d8( NAME, DOCS, FLAG, ENUM, MODL):
    """Wrapper function for lambda definitions."""
    if False:
        name = NotImplemented

    def _walrus_wrapper_name_1d27be50e93d4be49c5c4d36015b32d1(expr):
...
"""{(_walrus_wrapper_name_1d27be50e93d4be49c5c4d36015b32d1(DOCS.split(' [', maxsplit=1)[0]))}
{'=' * (len(name) + 6)}
...
LINE =_walrus_wrapper_lambda_4eac8db5acac499a9c002b6f9d37f8d8  # type: Callable[[str, str, str, str, str], str]
