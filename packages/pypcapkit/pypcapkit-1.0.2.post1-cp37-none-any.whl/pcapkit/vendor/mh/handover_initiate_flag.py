...
def _walrus_wrapper_lambda_db189be3c6614e93bc38c16433c12abd( NAME, DOCS, FLAG, ENUM, MODL):
    """Wrapper function for lambda definitions."""
    if False:
        name = NotImplemented

    def _walrus_wrapper_name_232f1edc1f244293be2e6f5ab1353620(expr):
...
"""{(_walrus_wrapper_name_232f1edc1f244293be2e6f5ab1353620(DOCS.split(' [', maxsplit=1)[0]))}
{'=' * (len(name) + 6)}
...
class {NAME}(IntFlag):
    ...
    def _missing_(cls, value: 'int') -> '{NAME}':
        ...
        return cls(value)
'''
LINE =_walrus_wrapper_lambda_db189be3c6614e93bc38c16433c12abd  # type: Callable[[str, str, str, str, str], str]
