...
def _walrus_wrapper_lambda_126abb00dad54fb5817b42d59624cb16( NAME, DOCS, FLAG, ENUM, MISS, MODL):
    """Wrapper function for lambda definitions."""
    if False:
        name = NotImplemented

    def _walrus_wrapper_name_2b04ac32b8b04be7857d5358230373d5(expr):
...
"""{(_walrus_wrapper_name_2b04ac32b8b04be7857d5358230373d5(DOCS.split(' [', maxsplit=1)[0]))}
{'=' * (len(name) + 6)}
...
LINE =_walrus_wrapper_lambda_126abb00dad54fb5817b42d59624cb16  # type: Callable[[str, str, str, str, str, str], str]
