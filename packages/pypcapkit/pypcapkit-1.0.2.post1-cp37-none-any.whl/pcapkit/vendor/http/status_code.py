...
def _walrus_wrapper_lambda_e3ff9a403a204f8fa19e0234aa71e175( NAME, DOCS, FLAG, ENUM, MISS, MODL):
    """Wrapper function for lambda definitions."""
    if False:
        name = NotImplemented

    def _walrus_wrapper_name_aa298051f2b24188802973fb7ae01de2(expr):
...
"""{(_walrus_wrapper_name_aa298051f2b24188802973fb7ae01de2(DOCS.split(' [', maxsplit=1)[0]))}
{'=' * (len(name) + 6)}
...
LINE =_walrus_wrapper_lambda_e3ff9a403a204f8fa19e0234aa71e175  # type: Callable[[str, str, str, str, str, str], str]
