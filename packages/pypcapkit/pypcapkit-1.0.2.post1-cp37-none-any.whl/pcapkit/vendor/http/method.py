...
def _walrus_wrapper_lambda_aa74dcf24e4b4f43b432807473a669e3( NAME, DOCS, ENUM, MODL):
    """Wrapper function for lambda definitions."""
    if False:
        name = NotImplemented

    def _walrus_wrapper_name_8a2da234d8854e10be28173a680b2e0a(expr):
...
"""{(_walrus_wrapper_name_8a2da234d8854e10be28173a680b2e0a(DOCS.split(' [', maxsplit=1)[0]))}
{'=' * (len(name) + 6)}
...
LINE =_walrus_wrapper_lambda_aa74dcf24e4b4f43b432807473a669e3  # type: Callable[[str, str, str, str], str]
