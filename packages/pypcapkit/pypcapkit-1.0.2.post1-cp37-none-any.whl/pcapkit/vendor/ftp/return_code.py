...
def _walrus_wrapper_lambda_c66082cc46a94294b9100855f137cf08( NAME, DOCS, FLAG, ENUM, MODL):
    """Wrapper function for lambda definitions."""
    if False:
        name = NotImplemented

    def _walrus_wrapper_name_b3990e43bd5a4fd1a7b4c5ab2d4f84b2(expr):
...
"""{(_walrus_wrapper_name_b3990e43bd5a4fd1a7b4c5ab2d4f84b2(DOCS.split(' [', maxsplit=1)[0]))}
{'=' * (len(name) + 6)}
...
LINE =_walrus_wrapper_lambda_c66082cc46a94294b9100855f137cf08  # type: Callable[[str, str, str, str, str], str]
