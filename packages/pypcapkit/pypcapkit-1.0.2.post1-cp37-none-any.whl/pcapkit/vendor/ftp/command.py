...
def _walrus_wrapper_lambda_4beddfe137964454a3519ecad94f731e( NAME, DOCS, ENUM, MODL):
    """Wrapper function for lambda definitions."""
    if False:
        name = NotImplemented

    def _walrus_wrapper_name_16e91704fc784d2ebf3f93cbc012755e(expr):
...
"""{(_walrus_wrapper_name_16e91704fc784d2ebf3f93cbc012755e(DOCS.split(' [', maxsplit=1)[0]))}
{'=' * (len(name) + 6)}
...
LINE =_walrus_wrapper_lambda_4beddfe137964454a3519ecad94f731e  # type: Callable[[str, str, str, str], str]
