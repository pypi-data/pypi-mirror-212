...
def _walrus_wrapper_lambda_abd2e656b76247598becc33c5ee4e984( NAME, DOCS, ENUM, MODL):
    """Wrapper function for lambda definitions."""
    if False:
        name = NotImplemented

    def _walrus_wrapper_name_00e6430bac6e4a48bad87e6005fb9f94(expr):
...
"""{(_walrus_wrapper_name_00e6430bac6e4a48bad87e6005fb9f94(DOCS.split(' [', maxsplit=1)[0]))}
{'=' * (len(name) + 6)}
...
LINE =_walrus_wrapper_lambda_abd2e656b76247598becc33c5ee4e984  # type: Callable[[str, str, str, str], str]
