...
class TCP(TraceFlow[BufferID, Buffer, Index, Packet[IPAddress]], Generic[IPAddress]):
    ...
    def submit(self) -> 'tuple[Index, ...]':
        ...
        def _walrus_wrapper_cached_a68b9c3b61504573a9973ccd532ecf36(expr):
            """Wrapper function for assignment expression."""
            nonlocal cached
            cached = expr
            return cached

        if (_walrus_wrapper_cached_a68b9c3b61504573a9973ccd532ecf36(self.__cached__.get('submit'))) is not None:
            return cached
