...
class Reassembly(Generic[PT, DT, IT, BT], metaclass=abc.ABCMeta):
    ...
    def count(self) -> 'int':
        ...
        def _walrus_wrapper_cached_183a1479bf004ff5aba9cae3fd3ca9d5(expr):
            """Wrapper function for assignment expression."""
            nonlocal cached
            cached = expr
            return cached
        if (_walrus_wrapper_cached_183a1479bf004ff5aba9cae3fd3ca9d5(self.__cached__.get('count'))) is not None:
            return cached
    ...
    def fetch(self) -> 'tuple[DT, ...]':
        ...
        *forcedly* obtain newly reassembled payload. Otherwise, the
        ...
        def _walrus_wrapper_cached_bc7ba85c3df64cc98661de740ddbd88b(expr):
            """Wrapper function for assignment expression."""
            nonlocal cached
            cached = expr
            return cached
        if (_walrus_wrapper_cached_bc7ba85c3df64cc98661de740ddbd88b(self.__cached__.get('fetch'))) is not None:
            return cached
