...
def ipv6_reassembly(frame: 'PCAPNG') -> 'IP_Packet[IPv6Address] | None':
    ...
    if 'IPv6' in frame:
        ...
        if False:
            ipv6_frag = NotImplemented

        def _walrus_wrapper_ipv6_frag_9a8fd299d82b4252a487f15069ea6845(expr):
            """Wrapper function for assignment expression."""
            nonlocal ipv6_frag
            ipv6_frag = expr
            return ipv6_frag

        if (_walrus_wrapper_ipv6_frag_9a8fd299d82b4252a487f15069ea6845(ipv6.extension_headers.get(  # type: ignore[call-overload]
