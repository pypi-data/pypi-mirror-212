...
def ipv6_reassembly(frame: 'Frame') -> 'IP_Packet[IPv6Address] | None':
    ...
    if 'IPv6' in frame:
        ...
        def _walrus_wrapper_ipv6_frag_4f938376931f4bc8b3c60719c4fca27e(expr):
            """Wrapper function for assignment expression."""
            nonlocal ipv6_frag
            ipv6_frag = expr
            return ipv6_frag

        if (_walrus_wrapper_ipv6_frag_4f938376931f4bc8b3c60719c4fca27e(ipv6.extension_headers.get(  # type: ignore[call-overload]
