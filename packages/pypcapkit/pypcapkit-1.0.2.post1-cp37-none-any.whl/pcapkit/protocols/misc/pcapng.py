...
def _walrus_wrapper_version_info_c762fa15b46c41358b604a3b14be0c94(expr):
...
def _walrus_wrapper_version_info_73dc0ebd59ea46fea5b8e5bada1fa5cb(expr):
    """Wrapper function for assignment expression."""
    global version_info
    version_info = expr
    return version_info
...
py37 = ((_walrus_wrapper_version_info_c762fa15b46c41358b604a3b14be0c94(sys.version_info)).major >= 3 and version_info.minor >= 7)
py38 = ((_walrus_wrapper_version_info_73dc0ebd59ea46fea5b8e5bada1fa5cb(sys.version_info)).major >= 3 and version_info.minor >= 8)
