...
class Protocol(Generic[PT, ST], metaclass=abc.ABCMeta):
    ...
    def expand_comp(value: 'str | Protocol | Type[Protocol]') -> 'tuple':
        ...
        if isinstance(value, type) and issubclass(value, Protocol):
            ...
            def _walrus_wrapper_proto_e7a55df5a3ab45a8ad4116059ca3fd60(expr):
                """Wrapper function for assignment expression."""
                nonlocal proto
                proto = expr
                return proto
            if (_walrus_wrapper_proto_e7a55df5a3ab45a8ad4116059ca3fd60(protocols_registry.get(value.upper()))) is not None:
    ...
    def __repr__(self) -> 'str':
        ...
        def _walrus_wrapper_cached_187dddd283e246d69de4747cccbb405d(expr):
            """Wrapper function for assignment expression."""
            nonlocal cached
            cached = expr
            return cached

        if (_walrus_wrapper_cached_187dddd283e246d69de4747cccbb405d(self.__cached__.get('__repr__'))) is not None:
            return cached
    ...
    def __str__(self) -> 'str':
        ...
        def _walrus_wrapper_cached_0290155c81ec4160a8471c7b9b99c735(expr):
            """Wrapper function for assignment expression."""
            nonlocal cached
            cached = expr
            return cached

        if (_walrus_wrapper_cached_0290155c81ec4160a8471c7b9b99c735(self.__cached__.get('__str__'))) is not None:
            return cached
    ...
    def __len__(self) -> 'int':
        ...
        def _walrus_wrapper_cached_24e5a78c162143aaafa13c359f255d93(expr):
            """Wrapper function for assignment expression."""
            nonlocal cached
            cached = expr
            return cached

        if (_walrus_wrapper_cached_24e5a78c162143aaafa13c359f255d93(self.__cached__.get('__len__'))) is not None:
            return cached
    ...
    def _check_term_threshold(self) -> bool:
        ...
        def _walrus_wrapper_layer_b6a85a15b5f049e09536610999c5bd95(expr):
            """Wrapper function for assignment expression."""
            nonlocal layer
            layer = expr
            return layer

        if self._exlayer is None or (_walrus_wrapper_layer_b6a85a15b5f049e09536610999c5bd95(self.__layer__)) is None:
            layer_match = False
        else:
