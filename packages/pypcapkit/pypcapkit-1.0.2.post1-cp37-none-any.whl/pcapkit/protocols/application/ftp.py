...
class FTP(Application[Data_FTP, Schema_FTP],
    ...
    def read(self, length: 'Optional[int]' = None, **kwargs: 'Any') -> 'Data_FTP':
        ...
        def _walrus_wrapper_match_1dbccc8f932f47b896c9c4dc561a9220(expr):
            """Wrapper function for assignment expression."""
            nonlocal match
            match = expr
            return match

        def _walrus_wrapper_match_ff3461ac09b74a429527036a3abc9bbe(expr):
            """Wrapper function for assignment expression."""
            nonlocal match
            match = expr
            return match

        if (_walrus_wrapper_match_1dbccc8f932f47b896c9c4dc561a9220(FTP_REQUEST.match(data))) is not None:
        ...
        elif (_walrus_wrapper_match_ff3461ac09b74a429527036a3abc9bbe(FTP_RESPONSE.match(data))) is not None:
