...
def _walrus_wrapper_lambda_65d752e325214426b6294a796fbdf70a( NAME, DOCS, ENUM, MODL):
    """Wrapper function for lambda definitions."""
    if False:
        name = NotImplemented

    def _walrus_wrapper_name_2304073b09064b1dbc1dade9e863b8e0(expr):
...
"""{(_walrus_wrapper_name_2304073b09064b1dbc1dade9e863b8e0(DOCS.split(' [', maxsplit=1)[0]))}
{'=' * (len(name) + 6)}
...
LINE =_walrus_wrapper_lambda_65d752e325214426b6294a796fbdf70a  # type: Callable[[str, str, str, str], str]
