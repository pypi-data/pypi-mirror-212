...
def _walrus_wrapper_lambda_dfb58b64e010436ca00b0a726e06c96e( NAME, DOCS, FLAG, ENUM, MODL):
    """Wrapper function for lambda definitions."""
    if False:
        name = NotImplemented

    def _walrus_wrapper_name_bffb8addff834191b1ab05766237ce34(expr):
...
"""{(_walrus_wrapper_name_bffb8addff834191b1ab05766237ce34(DOCS.split(' [', maxsplit=1)[0]))}
{'=' * (len(name) + 6)}
...
LINE =_walrus_wrapper_lambda_dfb58b64e010436ca00b0a726e06c96e  # type: Callable[[str, str, str, str, str], str]
