...
def _walrus_wrapper_lambda_f598a2d7ded746df93e1547018257150( NAME, DOCS, FLAG, ENUM, MODL):
    """Wrapper function for lambda definitions."""
    if False:
        name = NotImplemented

    def _walrus_wrapper_name_2d9e0f98831f4f35bb91ad72bb8c1f29(expr):
...
"""{(_walrus_wrapper_name_2d9e0f98831f4f35bb91ad72bb8c1f29(DOCS.split(' [', maxsplit=1)[0]))}
{'=' * (len(name) + 6)}
...
class {NAME}(IntFlag):
    ...
    def _missing_(cls, value: 'int') -> '{NAME}':
        ...
        return cls(value)
'''
LINE =_walrus_wrapper_lambda_f598a2d7ded746df93e1547018257150  # type: Callable[[str, str, str, str, str], str]
