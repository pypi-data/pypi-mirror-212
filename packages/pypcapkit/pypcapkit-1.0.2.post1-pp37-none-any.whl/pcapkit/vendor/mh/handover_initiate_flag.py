...
def _walrus_wrapper_lambda_64521fb640384d24a4fd0abd2436f437( NAME, DOCS, FLAG, ENUM, MODL):
    """Wrapper function for lambda definitions."""
    if False:
        name = NotImplemented

    def _walrus_wrapper_name_51cb878aa11041abac7cd4ab8e4eadb4(expr):
...
"""{(_walrus_wrapper_name_51cb878aa11041abac7cd4ab8e4eadb4(DOCS.split(' [', maxsplit=1)[0]))}
{'=' * (len(name) + 6)}
...
class {NAME}(IntFlag):
    ...
    def _missing_(cls, value: 'int') -> '{NAME}':
        ...
        return cls(value)
'''
LINE =_walrus_wrapper_lambda_64521fb640384d24a4fd0abd2436f437  # type: Callable[[str, str, str, str, str], str]
