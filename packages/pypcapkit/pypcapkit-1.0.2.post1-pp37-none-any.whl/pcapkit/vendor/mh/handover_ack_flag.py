...
def _walrus_wrapper_lambda_5619351f54eb402e86e5de4433a5c87c( NAME, DOCS, FLAG, ENUM, MODL):
    """Wrapper function for lambda definitions."""
    if False:
        name = NotImplemented

    def _walrus_wrapper_name_33835fd0f65d410089726c6ff62233e9(expr):
...
"""{(_walrus_wrapper_name_33835fd0f65d410089726c6ff62233e9(DOCS.split(' [', maxsplit=1)[0]))}
{'=' * (len(name) + 6)}
...
class {NAME}(IntFlag):
    ...
    def _missing_(cls, value: 'int') -> '{NAME}':
        ...
        return cls(value)
'''
LINE =_walrus_wrapper_lambda_5619351f54eb402e86e5de4433a5c87c  # type: Callable[[str, str, str, str, str], str]
