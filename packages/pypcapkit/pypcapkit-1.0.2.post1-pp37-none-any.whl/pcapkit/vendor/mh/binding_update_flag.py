...
def _walrus_wrapper_lambda_8182ccbeecd74a8dae0e7bdc1a73c716( NAME, DOCS, FLAG, ENUM, MODL):
    """Wrapper function for lambda definitions."""
    if False:
        name = NotImplemented

    def _walrus_wrapper_name_4910bf7a740f42209d7d10725156ca0e(expr):
...
"""{(_walrus_wrapper_name_4910bf7a740f42209d7d10725156ca0e(DOCS.split(' [', maxsplit=1)[0]))}
{'=' * (len(name) + 6)}
...
LINE =_walrus_wrapper_lambda_8182ccbeecd74a8dae0e7bdc1a73c716  # type: Callable[[str, str, str, str, str], str]
