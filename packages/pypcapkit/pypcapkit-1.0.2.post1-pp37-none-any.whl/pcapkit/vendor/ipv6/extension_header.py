...
def _walrus_wrapper_lambda_82a05729a9fd4259adf5e9f87470e0e0( NAME, DOCS, ENUM, MODL):
    """Wrapper function for lambda definitions."""
    if False:
        name = NotImplemented

    def _walrus_wrapper_name_6b12a31bfcf04f2f9396083b9305ede9(expr):
...
"""{(_walrus_wrapper_name_6b12a31bfcf04f2f9396083b9305ede9(DOCS.split(' [', maxsplit=1)[0]))}
{'=' * (len(name) + 6)}
...
LINE =_walrus_wrapper_lambda_82a05729a9fd4259adf5e9f87470e0e0  # type: Callable[[str, str, str, str], str]
