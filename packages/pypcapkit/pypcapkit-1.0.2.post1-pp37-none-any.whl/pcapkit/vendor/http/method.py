...
def _walrus_wrapper_lambda_f95c13ef05a549d58fd1b9f99eae6130( NAME, DOCS, ENUM, MODL):
    """Wrapper function for lambda definitions."""
    if False:
        name = NotImplemented

    def _walrus_wrapper_name_ee24a958319046ee8697596fdc37f03e(expr):
...
"""{(_walrus_wrapper_name_ee24a958319046ee8697596fdc37f03e(DOCS.split(' [', maxsplit=1)[0]))}
{'=' * (len(name) + 6)}
...
LINE =_walrus_wrapper_lambda_f95c13ef05a549d58fd1b9f99eae6130  # type: Callable[[str, str, str, str], str]
