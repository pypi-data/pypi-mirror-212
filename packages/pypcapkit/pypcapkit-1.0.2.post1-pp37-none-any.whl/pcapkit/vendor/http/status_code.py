...
def _walrus_wrapper_lambda_ea5ca8a3fc104b509ae7f2fb41bfb43d( NAME, DOCS, FLAG, ENUM, MISS, MODL):
    """Wrapper function for lambda definitions."""
    if False:
        name = NotImplemented

    def _walrus_wrapper_name_fb0b0ed620594cc1ade035ec37479cb6(expr):
...
"""{(_walrus_wrapper_name_fb0b0ed620594cc1ade035ec37479cb6(DOCS.split(' [', maxsplit=1)[0]))}
{'=' * (len(name) + 6)}
...
LINE =_walrus_wrapper_lambda_ea5ca8a3fc104b509ae7f2fb41bfb43d  # type: Callable[[str, str, str, str, str, str], str]
