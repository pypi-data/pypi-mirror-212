...
def _walrus_wrapper_lambda_7abb6f1d1243431cbbe233ddd80b1504( NAME, DOCS, FLAG, ENUM, MISS, MODL):
    """Wrapper function for lambda definitions."""
    if False:
        name = NotImplemented

    def _walrus_wrapper_name_1baded676df54f3aa50b320c44263462(expr):
...
"""{(_walrus_wrapper_name_1baded676df54f3aa50b320c44263462(DOCS.split(' [', maxsplit=1)[0]))}
{'=' * (len(name) + 6)}
...
LINE =_walrus_wrapper_lambda_7abb6f1d1243431cbbe233ddd80b1504  # type: Callable[[str, str, str, str, str, str], str]
