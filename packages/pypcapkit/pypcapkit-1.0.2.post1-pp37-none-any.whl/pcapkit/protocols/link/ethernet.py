...
def _walrus_wrapper_version_info_eae9f83312ff4568bfbcbc12694e141c(expr):
...
py38 = ((_walrus_wrapper_version_info_eae9f83312ff4568bfbcbc12694e141c(sys.version_info)).major >= 3 and version_info.minor >= 8)
