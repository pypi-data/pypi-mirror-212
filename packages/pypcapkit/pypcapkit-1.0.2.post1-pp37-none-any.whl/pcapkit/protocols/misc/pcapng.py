...
if False:
    version_info = NotImplemented


def _walrus_wrapper_version_info_516c8332e0fa40ec952a101ec5dc3f9e(expr):
...
def _walrus_wrapper_version_info_8c3faad27e7d44d19099c94aa953bb26(expr):
    """Wrapper function for assignment expression."""
    global version_info
    version_info = expr
    return version_info
...
py37 = ((_walrus_wrapper_version_info_516c8332e0fa40ec952a101ec5dc3f9e(sys.version_info)).major >= 3 and version_info.minor >= 7)
py38 = ((_walrus_wrapper_version_info_8c3faad27e7d44d19099c94aa953bb26(sys.version_info)).major >= 3 and version_info.minor >= 8)
