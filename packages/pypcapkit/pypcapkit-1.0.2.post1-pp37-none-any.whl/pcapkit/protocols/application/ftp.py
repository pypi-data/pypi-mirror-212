...
class FTP(Application[Data_FTP, Schema_FTP],
    ...
    def read(self, length: 'Optional[int]' = None, **kwargs: 'Any') -> 'Data_FTP':
        ...
        def _walrus_wrapper_match_c1457a8a282243a0aced29d94a641ea8(expr):
            """Wrapper function for assignment expression."""
            nonlocal match
            match = expr
            return match

        def _walrus_wrapper_match_fb1714c3afd6419abe1c8609fbeebc29(expr):
            """Wrapper function for assignment expression."""
            nonlocal match
            match = expr
            return match

        if (_walrus_wrapper_match_c1457a8a282243a0aced29d94a641ea8(FTP_REQUEST.match(data))) is not None:
        ...
        elif (_walrus_wrapper_match_fb1714c3afd6419abe1c8609fbeebc29(FTP_RESPONSE.match(data))) is not None:
