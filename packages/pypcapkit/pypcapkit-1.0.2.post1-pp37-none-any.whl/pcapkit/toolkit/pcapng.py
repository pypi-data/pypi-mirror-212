...
def ipv6_reassembly(frame: 'PCAPNG') -> 'IP_Packet[IPv6Address] | None':
    ...
    if 'IPv6' in frame:
        ...
        def _walrus_wrapper_ipv6_frag_9b612bba239d46b78150cd1748425b2d(expr):
            """Wrapper function for assignment expression."""
            nonlocal ipv6_frag
            ipv6_frag = expr
            return ipv6_frag

        if (_walrus_wrapper_ipv6_frag_9b612bba239d46b78150cd1748425b2d(ipv6.extension_headers.get(  # type: ignore[call-overload]
