...
def ipv6_reassembly(frame: 'Frame') -> 'IP_Packet[IPv6Address] | None':
    ...
    if 'IPv6' in frame:
        ...
        def _walrus_wrapper_ipv6_frag_51163450c15b4ca7b03a2c3a445f4f3a(expr):
            """Wrapper function for assignment expression."""
            nonlocal ipv6_frag
            ipv6_frag = expr
            return ipv6_frag

        if (_walrus_wrapper_ipv6_frag_51163450c15b4ca7b03a2c3a445f4f3a(ipv6.extension_headers.get(  # type: ignore[call-overload]
