...
class TCP(TraceFlow[BufferID, Buffer, Index, Packet[IPAddress]], Generic[IPAddress]):
    ...
    def submit(self) -> 'tuple[Index, ...]':
        ...
        def _walrus_wrapper_cached_000b6affc45046ffb218cd57e94aada1(expr):
            """Wrapper function for assignment expression."""
            nonlocal cached
            cached = expr
            return cached

        if (_walrus_wrapper_cached_000b6affc45046ffb218cd57e94aada1(self.__cached__.get('submit'))) is not None:
            return cached
