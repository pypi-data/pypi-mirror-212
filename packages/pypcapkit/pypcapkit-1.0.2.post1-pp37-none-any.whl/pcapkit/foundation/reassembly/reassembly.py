...
class Reassembly(Generic[PT, DT, IT, BT], metaclass=abc.ABCMeta):
    ...
    def count(self) -> 'int':
        ...
        def _walrus_wrapper_cached_d1ab37d95f3e426da22f7e558277b9d1(expr):
            """Wrapper function for assignment expression."""
            nonlocal cached
            cached = expr
            return cached
        if (_walrus_wrapper_cached_d1ab37d95f3e426da22f7e558277b9d1(self.__cached__.get('count'))) is not None:
            return cached
    ...
    def fetch(self) -> 'tuple[DT, ...]':
        ...
        *forcedly* obtain newly reassembled payload. Otherwise, the
        ...
        def _walrus_wrapper_cached_08b424976c364cfdbecbf19ab219ba3b(expr):
            """Wrapper function for assignment expression."""
            nonlocal cached
            cached = expr
            return cached
        if (_walrus_wrapper_cached_08b424976c364cfdbecbf19ab219ba3b(self.__cached__.get('fetch'))) is not None:
            return cached
