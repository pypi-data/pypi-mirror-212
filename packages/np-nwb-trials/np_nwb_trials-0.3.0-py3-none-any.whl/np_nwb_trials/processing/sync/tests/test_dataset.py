import h5py
import numpy as np
from sync import Dataset, __version__
import json
import pytest
from mock import patch
try:
    # Plotting functions isolate the matplotlib import so it
    # isn't a required dependency. Only test them if it is
    # available
...
@pytest.mark.skipif(SKIP_PLOT_TESTS, reason="Skip if no matplotlib")
