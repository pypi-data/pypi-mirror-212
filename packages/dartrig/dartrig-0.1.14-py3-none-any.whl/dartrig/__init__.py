...
from dartrig.parser import extract_nodes, parse_dsaf, is_financial_company
...
class DartWeb:
    ...
    def get_dsaf_meta(self, company, rcp_no) -> Dict[str, any]:
        ...
        try:
            ...
            nodes = self.get_dsaf_nodes(rcp_no=rcp_no)
