    ...
    def load_dataset(dataset_name: Union[str, list],
        ...
        **kwargs) -> Union[dict, 'AILabDataset']:
        ...
        if is_local_path :
            ...
            dataset_name_file = dataset_name_split[-1].strip()
            dataset_name_format_spit = dataset_name_file.split('.')
            dataset_name_format = dataset_name_format_spit[-1].strip()
            hf_set = HFDatasetAPI.load_disk(dataset_name, dataset_name_format)
