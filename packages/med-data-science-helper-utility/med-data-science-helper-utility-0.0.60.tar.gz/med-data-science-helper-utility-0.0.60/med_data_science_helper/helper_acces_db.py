...
def get_df_notas(anio,liker=True,notas_group=None,cache=True):
    ...
    if notas_group is None:
        ...
        df_chunk = pd.read_csv(url_notas ,encoding='utf-8', dtype=dtype,chunksize=10000000)
    ...
    gc.collect()
    df_notas.rename(columns ={"NOTA_ASIGNATURA_REGULAR":"NOTA_AREA_REGULAR"}, inplace=True)
