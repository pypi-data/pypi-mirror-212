...
def save_torch_results(run_id, test_dataloader=None, test_dataloader_name='test', model=None, weights=None, threshold = 0.5, problem_type = 'binary classification', hist=False, bins=20):
