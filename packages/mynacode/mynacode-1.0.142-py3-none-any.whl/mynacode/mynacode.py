...
def save_torch_results(run_id, test_dataloader=None, model=None, weights=None, threshold = 0.5, problem_type = 'binary classification', hist=False, bins=20):
    ...
    if test_dataloader==None:
      try:
        test_dataloader = load_torch_dataloader(run_id, 'test_dataloader')
      except:
