...
class ProtoWrapper():
    ...
    @classmethod
    def wrap_knowledge(cls, knowledge_dict: dict, is_json=False, life_cycle="DEFAULT", life_cycle_turns=0) -> Knowledge:
            ...
            for group_key in knowledge_dict:
                ...
                for info_id in group_info:
                    ...
                    if is_json:
                        ...
                        if life_cycle == 2:
                            info_item_proto.life_cycle_turns = life_cycle_turns
                            print("life_cycle_turns: ", info_item_proto.life_cycle_turns)
                    else:
...
class ModelContextParser():
    ...
    @classmethod
    def set_knowledge(cls, knowledge_dict: Dict, is_json: bool, life_cycle, life_cycle_turns, output_proto: ModelServiceOutput):
        try:
            knowledge_proto = ProtoWrapper.wrap_knowledge(knowledge_dict, is_json, life_cycle, life_cycle_turns)
