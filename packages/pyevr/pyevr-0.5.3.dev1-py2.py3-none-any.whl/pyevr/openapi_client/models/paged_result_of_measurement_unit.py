...
class PagedResultOfMeasurementUnit(object):
    ...
    openapi_types = {
        'page_number': 'int',
        'page_size': 'int',
        'page_result': 'list[MeasurementUnit]',
        'total_count': 'int'
    }
    ...
    def __init__(self, page_number=None, page_size=None, page_result=None, total_count=None, local_vars_configuration=None):  # noqa: E501
        """PagedResultOfMeasurementUnit - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PagedResultOfMeasurementUnit):
            return False
