...
class PagedResultOfAssortment(object):
    ...
    def __init__(self, page_number=None, page_size=None, page_result=None, total_count=None, local_vars_configuration=None):  # noqa: E501
        """PagedResultOfAssortment - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PagedResultOfAssortment):
            return False
