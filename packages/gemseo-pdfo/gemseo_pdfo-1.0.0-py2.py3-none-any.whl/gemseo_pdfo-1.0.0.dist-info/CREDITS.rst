...
The developers thank all the open source libraries making GEMSEO-pdfo possible.

External Dependencies
---------------------

GEMSEO-pdfo depends on software with compatible licenses that are listed below.
...
GEMSEO-pdfo source code includes software with compatible licenses that are listed below.
