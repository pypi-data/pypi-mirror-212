...
# -*- coding: utf-8 -*-
#
# tkwant documentation build configuration file, created by
# sphinx-quickstart on Sun May 22 14:08:28 2016.
#
...
latex_documents = [
    (master_doc, 'tkwant.tex', 'tkwant {0} documentation'.format(release),
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'tkwant', 'tkwant Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'tkwant', 'tkwant Documentation',
     author, 'tkwant', 'One line description of project.',
     'Miscellaneous'),
]
...
intersphinx_mapping = {
    ...
    'kwantspectrum': ('https://kwant-project.org/extensions/kwantspectrum/', None)
}
