...
class DropdownDisabled(Dropdown):
    ...
    def __init__(self, children=None, **dropdown_props):
        dropdown_props['style'] = dropdown_disabled
...
class dropdownIconLarge(Dropdown):
    ...
    def __init__(self, children=None, **dropdown_props):
        dropdown_props['style'] = dropdown_icon_large
        super().__init__(children=children, **dropdown_props)
...
class DropdownIconMedium(Dropdown):
    ...
    def __init__(self, children=None, **dropdown_props):
        dropdown_props['style'] = dropdown_icon_medium
        super().__init__(children=children, **dropdown_props)
...
class DropdownIconShort1(Dropdown):
    ...
    def __init__(self, children=None, **dropdown_props):
        dropdown_props['style'] = dropdown_icon_short
        super().__init__(children=children, **dropdown_props)
