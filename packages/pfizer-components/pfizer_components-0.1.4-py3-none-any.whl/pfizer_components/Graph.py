...
class Graph(dcc.Graph):
    ...
    - animation_options (dict; default {    frame: {        redraw: False,    },    transition: {        duration:
    750,        ease: 'cubic-in-out',    },}): Beta: Object containing animation settings. Only applies if `animate`
    is `True`.
...
class Graph1ExtraLarge(Graph):
    ...
    def __init__(self, children=None, **graph_props):
        graph_props['style'] = graph_1_extra_large
        super().__init__(children=children, **graph_props)
...
class GraphLarge(Graph):
    ...
    def __init__(self, children=None, **graph_props):
        graph_props['style'] = graph_1_large
        super().__init__(children=children, **graph_props)
...
class Graph1Medium(Graph):
    ...
    def __init__(self, children=None, **graph_props):
        graph_props['style'] = graph_1_medium
        super().__init__(children=children, **graph_props)
...
class Graph2ExtraLarge(Graph):
    ...
    def __init__(self, children=None, **graph_props):
        graph_props['style'] = graph_2_extra_large
        super().__init__(children=children, **graph_props)
...
class Graph2Medium(Graph):
    ...
    def __init__(self, children=None, **graph_props):
        graph_props['style'] = graph_2_medium
        super().__init__(children=children, **graph_props)
