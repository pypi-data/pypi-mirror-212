...
class RangeSlider(dcc.RangeSlider):
    ...
    def __init__(self, children=None, **range_slider_props):
        range_slider_props = range_slider_props.copy() if range_slider_props else {}
        style = range_slider_props.pop('style', None)
        default_style = {}
        if style is not None:
            default_style.update(style)
        range_slider_props['style'] = default_style
        super().__init__(children=children,**range_slider_props)
