...
def default_policy(item, tag='', max_len=1000, max_par_num=40):
    """
...
def best_effort_display_policy(item, tag='', max_len=1000, max_par_num=40, suffix='...'):
    """
    ...
    full = '<b>' + item['title'] + '</b>\n\n' + item['paragraphs'] + item['time'] + '\n' + \
           '[' + item['source'] + ']' + '<a href=\"' + item['link'] + '\">LATEST UPDATE FROM ' + tag + ' SECTION</a>' + ' '
