...
def login(user, token):
    ...
    """
    _manager.override_login_config(user, token)
...
class XetFS(fsspec.spec.AbstractFileSystem):
    ...
    def __init__(self, domain='xethub.com'):
        ...
        ```
        import pyxet
        fs = pyxet.XetFS('xet://XetHub/Flickr30k/main/results.csv')
        fs = pyxet.XetFS('/XetHub/Flickr30k/main/')
        fs = pyxet.XetFS('xet://XetHub/Flickr30k/', branch = 'main')
        ...
        If no branch is provided, it defaults to 'main'
