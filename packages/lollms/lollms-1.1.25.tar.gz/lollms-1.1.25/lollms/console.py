        ...
        while True:
            try:
                ...
                if prompt == "context_infos":
                    ...
                    print(f"{ASCIIColors.color_green}Current context has {len(tokens)} tokes/ {self.config.ctx_size}{ASCIIColors.color_reset}")
                    continue                
                ...
                if self.personality.processor is not None and self.personality.processor_cfg["custom_workflow"]:
                    ...
                    print(output)
                    print(f"{ASCIIColors.color_green}ok{ASCIIColors.color_reset}")
                else:
