...
class ZeroShotRelationExtractorLegal:
    @staticmethod
    def get_default_model():
        from sparknlp_jsl.legal.graph.relation_extraction.zero_shot_relation_extraction import ZeroShotRelationExtractionModel
