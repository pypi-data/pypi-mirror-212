class AssertionDLLegal:
    @staticmethod
    def get_default_model():
        from sparknlp_jsl.legal.chunk_classification.assertion.assertionDL import AssertionDLModel
    ...
    def get_default_trainable_model():
        from sparknlp_jsl.legal.chunk_classification.assertion.assertionDL import AssertionDLApproach
