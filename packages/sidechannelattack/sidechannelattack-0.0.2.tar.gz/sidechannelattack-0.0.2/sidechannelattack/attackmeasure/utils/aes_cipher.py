...
Running this file as __main__ will result in a self-parallel of the algorithm.
...
class AESCipher:
    ...
    def cipher_block (self, state):
        ...
        #PKCS7 Padding
        state=state+[16-len(state)]*(16-len(state))#Fails parallel if it changes the input with +=
