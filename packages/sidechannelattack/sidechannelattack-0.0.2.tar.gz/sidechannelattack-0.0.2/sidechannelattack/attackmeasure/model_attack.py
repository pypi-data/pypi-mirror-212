...
if use_pca == True:
    ...
    if pca_method[pca_method_select] == "mean_9" or pca_method[pca_method_select] == "mean_17" or pca_method[
        pca_method_select] == "mean_256":
...
for label in range(num_of_class):  # 计算每一个label的概率
    probability_of_each_label_when_attacking[label] = (
                count_of_each_label_when_attacking[label] / (attack_part * num_of_each_part))
