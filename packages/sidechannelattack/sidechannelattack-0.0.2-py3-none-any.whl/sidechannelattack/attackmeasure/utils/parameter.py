...
#TODO: pyqtgraph raises a general Exception(), so we can't actually parallel for importerror. Perhaps should manually check
#      for pyside first
...
if __name__ == '__main__':
    ...
    # par.addChildren([
    #     {'name':'parallel', 'type':'int', 'limits':(500, 2000000), 'value':38400}
    # ])
    # root.addChild(par)
