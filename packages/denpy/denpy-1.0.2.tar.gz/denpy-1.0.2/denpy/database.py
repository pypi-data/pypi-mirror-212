...
def edit(table: str, data: str, new_data: str, where: str = None):
    database, cursor = connect()
    if where is None:
...
def remove(table: str, where: str = None):
    database, cursor = connect()
    if where is None:
