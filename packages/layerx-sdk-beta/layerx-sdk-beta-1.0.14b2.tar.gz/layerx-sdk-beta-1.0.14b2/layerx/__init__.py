...
class LayerxClient:
    ...
    def __trash_objects(
        ...
        response = _datalake_client.get_selection_id(collection_id, query, filter, 0, object_list, is_all_selected)
    ...
    def trash_objects_from_collection(
        ...
        try:
            ...
            response = self.__trash_objects(collection_id, query, filter, object_type, [], True)
            return response
        except Exception as e:
            print("An exception occurred", format(e))
            return {
