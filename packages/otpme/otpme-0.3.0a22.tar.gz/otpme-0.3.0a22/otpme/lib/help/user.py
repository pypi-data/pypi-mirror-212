...
cmd_help = {
    ...
    'add'    : {
                    '_cmd_usage_help' : 'Usage: otpme-user add [--no-default-token] [--group <group>] [-t] [--template <template_name>] [--no-qrcode] {user}',
                    'cmd'   :   '--group :group: --no-default-token :add_default_token=False: --default-token :default_token: -t :template_object=True: --template :template_name: --no-qrcode :gen_qrcode=False: <|object|>',
                    '_help' :   {
                                    'cmd'                           : 'Add new user.',
