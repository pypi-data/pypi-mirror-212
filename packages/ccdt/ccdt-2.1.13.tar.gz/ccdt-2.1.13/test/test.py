...
def get_args():
    ...
    parser.add_argument('--input_dir', type=str,
                        ...
                        default=r'/my_tmp/08.fall_fall_doubt-zy-20230406/test_images/boss_to_dataset/02.collect_datasets',
    ...
    parser.add_argument('--output_dir', type=str,
                        ...
                        default=r'/my_tmp/08.fall_fall_doubt-zy-20230406/result_images/boss_to_dataset',
...
if __name__ == '__main__':
    args = get_args()
    comman_pool = '/work/darknet detector test all_data.data yolov3.cfg work_dirs/yolov3_40000.weights -thresh 0.5 -dont_show'
    # 获取逻辑 CPU 数量
