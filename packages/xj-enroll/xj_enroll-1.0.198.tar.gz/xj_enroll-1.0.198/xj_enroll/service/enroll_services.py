...
class EnrollServices:
    ...
    @staticmethod
    def __record_aggregate_by_enroll(enroll_id: int = None, enroll_id_list: list = None):
        """根据报名ID对记录进行聚合"""
    ...
    def enroll_list(params: dict = None, filter_fields: "list|str" = None, need_pagination: bool = True, **kwargs):
        ...
        # 获取当前的报名
        try:
            data, err = EnrollServices.__record_aggregate_by_enroll(enroll_id_list=enroll_id_list)
