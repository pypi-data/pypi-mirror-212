...
class HTSCollectWrapper(CollectStepWrapper):
    ...
    def _allocation(self) -> None:
        ...
        preds_col = [HTSInferenceDriverV2.PREDICTED_COLUMN_NAME]
        ...
        if HTSInferenceDriverV2.ACTUAL_COLUMN in self._allocated_df.columns:
            keep_cols_list.append(HTSInferenceDriverV2.ACTUAL_COLUMN)
    ...
    def disaggregate_predictions(
        ...
        if forecast_quantiles:
            ...
            disagg_cols = [HTSInferenceDriverV2.PREDICTED_COLUMN_NAME]
        if HTSInferenceDriverV2.ACTUAL_COLUMN in preds_df.columns:
            disagg_cols.append(HTSInferenceDriverV2.ACTUAL_COLUMN)
        partial_res = []
        if graph.training_level == HTSConstants.HTS_ROOT_NODE_LEVEL:
