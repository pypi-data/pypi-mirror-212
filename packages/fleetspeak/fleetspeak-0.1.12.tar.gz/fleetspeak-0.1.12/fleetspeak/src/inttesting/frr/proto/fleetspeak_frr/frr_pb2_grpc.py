...
class Master(object):
    ...
    def RecordTrafficResponse(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/fleetspeak.frr.Master/RecordTrafficResponse',
    ...
    def RecordFileResponse(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/fleetspeak.frr.Master/RecordFileResponse',
    ...
    def CompletedRequests(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/fleetspeak.frr.Master/CompletedRequests',
    ...
    def CreateHunt(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/fleetspeak.frr.Master/CreateHunt',
