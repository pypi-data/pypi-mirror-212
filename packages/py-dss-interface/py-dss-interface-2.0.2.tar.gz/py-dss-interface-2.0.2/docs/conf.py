...
#!/usr/bin/env python
#
# py_dss_interface documentation build configuration file, created by
...
# version = py_dss_interface.__version__
# # The full version, including alpha/beta/rc tags.
# release = py_dss_interface.__version__
...
# html_static_path = ['_static'] # TODO Enio to check

# -- Options for HTMLHelp output ---------------------------------------

# Output file base name for HTML help builder.
htmlhelp_basename = 'py_dss_interface_doc'
