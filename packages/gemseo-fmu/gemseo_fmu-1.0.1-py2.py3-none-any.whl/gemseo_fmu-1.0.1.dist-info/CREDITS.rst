...
The developers thank all the open source libraries making GEMSEO-fmu possible.

External Dependencies
---------------------

GEMSEO-fmu depends on software with compatible licenses that are listed below.
...
GEMSEO-fmu source code includes software with compatible licenses that are listed below.
