...
app = Blueprint('navigation', __name__, url_prefix="/navigation")
...
def load_navigation():
    ...
    return render_template("application_admin/load_navigation.html", message=message, successful=successful)