...
So for now, this is a simple import test to ensure the API module can at least be imported standalone
without errors (and to improve the code coverage).
"""

def test_api_import() -> None:
    from ciqar.templates.api import (
        ReportFile, SummaryData, FileListRow, RuleListRow, ViolationListRow, SourceLine
    )
