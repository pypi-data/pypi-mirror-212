...
from ciqar.input.linter.result_parser import ParsedMessageType, LinterResultParser, GlobalWarning
...
@pytest.mark.parametrize("parsed_messages, excluded_files", [
    ([], []),
...
class TestLinterResultCollector:
    ...
    def test_get_global_messages(
            self,
            parsed_messages: list[ParsedMessageType],
