...
def test_generate_example_setup():
    ...
    temp_image_folder_path = os.path.join(current_path, '01234567(test_uid)', 'temp_image')
...
def test_create_example_py_file(test_generate_example_setup):
    example_py_path, icon_folder_path, temp_image_folder_path, ui_folder_path, device_folder_path = test_generate_example_setup
