...
Keep in mind, to use this with dateutil (don't use pytz), you have to add
`git+https://github.com/ts-accessio/schedule.git@dateutil-support#egg=schedule` to the requirements of your service.
