...
The developers thank all the open source libraries making GEMSEO-pseven possible.

External Dependencies
---------------------

GEMSEO-pseven depends on software with compatible licenses that are listed below.
...
GEMSEO-pseven source code includes software with compatible licenses that are listed below.

External application
--------------------

Some external applications are used by GEMSEO-pseven,
...
Some icons and fonts are used by GEMSEO-pseven or its documentation.
