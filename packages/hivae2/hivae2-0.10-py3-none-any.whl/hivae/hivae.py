...
class hivae(object):
    ...
    def __del__(self):
        ...
        if tempdir:
            self.vprint(2,f'Deleting temp dir {tempdir}')
    ...
    def save_data(self,the_main_directory,the_path,the_data):
        self.vprint(0,'Saving {:40s} in {:40s}'.format(the_path,the_main_directory))
        dir_present = False
        try:
    ...
    def _training(self,
        ...
        self.vprint(1,'len(training_data)',len(training_data))
