...
class Report:
    def __init__(self, Id, Name: str, Description: str, Path: str, ParentFolderId: str, Content: str, ContentType: str = '', Size: int = 0, HasDatasource: bool = True, HasSharedDataSets: bool = False, HasParameters: bool = True):
        self.Id = Id
        self.Name = Name
        self.Description = Description
        self.Path = Path
    ...
    def __iter__(self):
        yield from {
            ...
            "ContentType": self.ContentType,
            "Size": self.Size,
            "HasDatasource": self.HasDatasource,
