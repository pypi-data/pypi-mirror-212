...
type IOperatorFunc<T> = (args: T, jcadContent: IJCadContent) => TopoDS_Shape | undefined;
export type IAllOperatorFunc = IOperatorFunc<IBox> | IOperatorFunc<ICylinder> | IOperatorFunc<ISphere> | IOperatorFunc<ICone> | IOperatorFunc<ITorus> | IOperatorFunc<ICut> | IOperatorFunc<IFuse> | IOperatorFunc<IIntersection> | IOperatorFunc<IExtrusion> | IOperatorFunc<ISketchObject>;
export type IOperatorArg = IBox & ICylinder & ISphere & ICone & ITorus & ICut & IFuse & IExtrusion & ISketchObject;
export {};
